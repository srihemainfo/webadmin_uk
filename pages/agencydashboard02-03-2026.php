                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <i class="fa fa-edit d-none text-dark cursor-pointer edit-section-trigger" data-section="aadhaar"
                                title="Edit"></i>
                        </div>
                        ...
                        <div class="edit-mode" id="edit-aadhaar" style="display: none;">
                            <div class="row g-2">
                                ...
                                <div class="col-12 mt-2 text-end">
                                    <button class="btn btn-sm btn-success me-2 save-section" data-section="aadhaar"><i
                        ...
                        <div class="edit-mode" id="edit-license" style="display: none;">
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="month" class="form-control form-control-sm edit-field"
                                        id="edit_license_expiry" value="2028-12">
                                </div>
                                <div class="col-12 mt-2 text-end">
                                    <button class="btn btn-sm btn-success me-2 save-section" data-section="license"><i
                                            class="fa fa-save me-1"></i>Save</button>
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <i class="fa fa-edit text-dark cursor-pointer d-none edit-section-trigger" data-section="documents"
                                title="Edit"></i>
                        </div>
                        ...
                        <div class="view-mode" id="view-documents">
                            <div class="row text-center g-3">
                                ...
                                <!-- RC -->
                                <div class="col-4">
                                    <h6 class="fw-semibold mb-2">RC</h6>
                                    <div class="document-box-small viewable-image" id="rcDocument">
                        ...
                        <div class="edit-mode" id="edit-documents" style="display: none;">
                            <div class="row text-center g-3">
                                ...
                                <div class="col-4">
                                    <h6 class="fw-semibold mb-2">RC</h6>
                                    <div class="document-box-small" id="edit-rcDocument" data-target="rcDocument">
                                        <img src="assets/images/lic-front.png" class="document-img" alt="RC">
                                        <div class="upload-overlay">
                                            <i class="fa fa-camera text-white"></i>
                                            <input type="file" class="file-input-hidden" accept="image/*"
                                                data-target="rcDocument">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-end mt-3">
                                <button class="btn btn-sm btn-success me-2 save-section" data-section="documents">
                                    <i class="fa fa-save me-1"></i>Save
                                </button>
...
`;
    ...
    $(document).ready(function () {
        ...
        function renderJobCard(job, jobId) {
            ...
            return `
    <div class="card mb-2 shadow-sm border-0">
      <div class="card-body p-3 ${job.global_type == 'open' ? 'card-open' : ''}">
        <div class="d-flex justify-content-between align-items-start mb-2">
          <div class="d-flex align-items-center gap-2">
         ...
         <h6 class="mb-0 fw-bold d-flex align-items-center gap-2">
            ...
            ${job.job_no && String(job.job_no).startsWith('GRD') && !['cancelled','expired','deleted'].includes(job.job_status) ? `
        ...
        function openDriverEditDrawer(id) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    setImage('#licenseFront img', vehicleData.rc_front_image_url);
                    setImage('#licenseBack img', vehicleData.rc_back_image_url);
                    ...
                    setImage('#rcDocument img', vehicleData.rc_front_image_url);
                    setImage('#pucDocument img', vehicleData.puc_details?.image_url);
                    setImage('#insuranceDocument img', vehicleData.insurance_details?.image_url);
        ...
        function getSectionData(section, driverId) {
            ...
            switch (section) {
                ...
                case 'license':
                    data = {
                        ...data,
                        method: 'update_driver_license',
                        dl_expiry: $('#edit_license_expiry').val()
                    };
                    break;
            }
        ...
        function updateSectionDisplay(section) {
            ...
            switch (section) {
                ...
                case 'license':
                    ...
                    $('#display_license_expiry').text(formatted);
                    break;
            }
        }
...
<script>
    ...
    function showValidationToast(message) {
        ...
        $('body').append(toastHtml);
        setTimeout(() => {
            $('.custom-validation-toast').fadeOut(300, function() { $(this).remove(); });
        }, 2500);
    }
    ...
    $(document).on('keypress', '#passengers', function(e) {
        if (e.which < 48 || e.which > 57) { e.preventDefault(); return false; }
    ...
    $(document).on('click', '.confirmGrdBtn', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    data: { job_id: jobId, job_no: jobNo },
                    headers: { "Authorization": "Bearer asdfghjklpoiuytrewqzxcvbnm!@$%^&*()" },
                    beforeSend: function () {
                        Swal.fire({ title: 'Confirming...', allowOutsideClick: false, didOpen: () => { Swal.showLoading(); } });
                    },
                    success: function (res) {
                        if (res.status) {
        ...
        function updateConfirmStatus(jobId, jobNo, status, onSuccessCallback = null) {
            $.ajax({
                ...
                type: "POST",
                dataType: "json",
                data: { job_id: jobId, job_no: jobNo, confirm_status: status },
                headers: { "Authorization": "Bearer asdfghjklpoiuytrewqzxcvbnm!@$%^&*()" },
                beforeSend: function () {
        ...
        function cancelJobApi(jobId, jobNo, userId, jobType) {
            $.ajax({
                ...
                beforeSend: function () {
                    Swal.fire({ title: 'Deleting from Firebase...', allowOutsideClick: false, didOpen: () => { Swal.showLoading(); } });
                },
                success: function(res) {
                    if (res.status) {
