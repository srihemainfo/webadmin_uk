   ...
   <div class="side-app">
      ...
      <div class="main-container container-fluid">
         ...
         <div class="page-header">
            <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Wallet Purchase</h1>
            <div>
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="" id="anchor">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Wallet Purchase</li>
               </ol>
            </div>
         </div>
         <!-- PAGE-HEADER END -->
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-3 col-sm-6 mb-2">
                                    ...
                                    <select id="userType" class="form-control">
                                       ...
                                       <option value="PICKUPTOSTORE">Pick up store</option>
                                       <option value="DELIVERYTOCUSTOMER">Delivery</option>
                                    </select>
                                 </div>
                              </div>
                              <div class="col-lg-3 col-sm-6 mb-2">
         ...
         <div class="col-lg-12">
            <div class="card">
               <div class="card-header">
                  <div class="col-lg-4">
                     <h3 class="card-title"><strong>Wallet purchase</strong></h3>
                  </div>
                  <div class="col-lg-8">
                  </div>
               </div>
                     ...
                     <table class="table table-bordered text-nowrap border-bottom" id="sms_report1" style="width:100%;">
                        <thead>
                           <tr>
                              ...
                              <th class="wd-15p border-bottom-0">Purchase Amount</th>
                              <th class="wd-15p border-bottom-0">Clossing Balance</th>
...
<script>
   ...
   var title = 'Wallet Purchase : (' + formdate + '  to  ' + todate + ') ' + (userType != '' ? userType : "");
   ...
   var table = $("#sms_report1").DataTable({
       ...
       columns: [
           ...
           {
              data: 'wallet_opening_balance'
          },
          {
              data: 'wallet_total'
          },
          {
              data: 'wallet_closeing_balance'
          },
          {
              data: 'Product_rate'
          },
