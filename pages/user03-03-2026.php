   ...
   <div class="side-app">
    ...
    <input class="form-control" type="text"
           ...
           oninput="this.value = this.value.replace(/[^0-9- \/]/g, '');">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <label class="form-label fw-semibold mb-1">Deleted Status</label>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="exampleTable" style="width:100%;">
                           <thead>
                              <tr>
                                 ...
                                 <th class="wd-25p border-bottom-0">Password</th>
   ...
   function viewtable() {
   	...
   	if (datefrom == '' || datefrom != '' || datefill != '' || datefill == '' || fieldname != '' || deletedstatus != '' || deletedstatus == '') {
   		...
   		if ((datefrom != '' || datefill != '') && (deletedstatus == 1 && deletedstatus != "")) {
   			var excelTitle = 'My Users List Reports : (' + fieldname + ' ' + "Deleted <?= $addName; ?>" + ' ' + datefrom + ' to ' + datefill + ')';
   		} else if ((datefrom != '' || datefill != '') && (deletedstatus == 0 && deletedstatus != "")) {
   			var excelTitle = 'My Users List Reports : (' + fieldname + ' ' + "Active <?= $addName; ?>" + ' ' + datefrom + ' to ' + datefill + ')';
   		} else if (datefrom != '' || datefill != '') {
   			var excelTitle = 'My Users List Reports : (' + fieldname + ' ' + datefrom + ' to ' + datefill + ')';
   		} else if (deletedstatus == 1) {
   			var excelTitle = 'My Users List Reports : (' + fieldname + ' ' + "Deleted <?= $addName; ?>" + ')';

   		} else if (deletedstatus == "") {
   			var excelTitle = 'My Users List Reports : (all data)';

   		} else if (deletedstatus == 0) {
   			var excelTitle = 'My Users List Reports : (' + fieldname + ' ' + "Active <?= $addName; ?>" + ')';
