<style>
    /* Match your custom back arrow style */
    .back-arrow-btn i {
        background: #ffffff;
        font-size: 16px;
        padding: 2px 3px;
    ...
    /* Cursor pointer for status badges */
    .cursor-pointer {
        cursor: pointer;
    }
</style>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-bottom-0 d-flex justify-content-between align-items-center">
                            <h3 class="card-title">City Slugs List</h3>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap border-bottom" id="slugTable" style="width:100%;">
                                    <thead>
                                        <tr>
                                            <th width="5%">S.No</th>
                                            <th>Slug Name</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="modalTitle">Add New Slug</h5>
            ...
            <div class="modal-body">
                <form id="slugForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slugName" name="slug" placeholder="e.g. drop-taxi" required>
                    </div>
                </form>
            </div>
...
<script>
    ...
    // Update this path if your PHP backend file is located elsewhere
    var ajaxUrl = origin + "/ajax/service/city_slug_service.php"; 
    var slugTable;
