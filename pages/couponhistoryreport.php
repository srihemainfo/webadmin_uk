 ...
 *     
 *      1-6-2023         Prakash             Report Has been developed
 * */
                                    ...
                                    <div class="">
                                        <div class="mt-2">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-2">
                                                    <label for="searchtxt"><strong>Select Affiliate User</strong></label> <br>
                                                    <select id="user_id" class="form-select">
                                                        <option value="">Select User</option>
                                                        <?php if ($get_affiliate_user['nr'] > 0) {
                                                            foreach ($get_affiliate_user['result'] as $key => $value) { ?>
                                                ...
                                                <div class="col-lg-3 col-sm-6 mb-2">
                                                    <label for="searchtxt"><strong>Number of coupon</strong></label> <br>
                                                    <input class="form-control" type="text" name="totcoupon" id="totcoupon" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="3">
                                                </div>
                                                ...
                                                <div class="col-3" id="gcBtn">
                                                    ...
                                                    <button class="btn btn-info"><i class="fa fa-download"></i> Download Coupon Code</button>
                                                </div>
                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <h3 class="card-title"><strong>Coupon List</strong></h3>
                                </div>
...
<script>
    ...
    function viewtable() {
        ...
        var title = 'Cuopon Reports : (' + formdate + '  to  ' + todate + ')';
