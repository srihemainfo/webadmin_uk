...
3-2-2023  Prakash             Ticket Generation option disabled
18-8-2023  Divya              excel file name changes
-->
...
if ($tabID == 'customer' || $tabID == 'offline-ticket') {
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Manual Tickets</h1>
				...
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Manual Tickets</li>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="table-responsive">
							...
							<table class="table table-bordered text-nowrap border-bottom" id="manualtickettable" style="width:100%;">
			...
			<div class="cls_form_div">
				...
				<form class="login100-form validate-form cls_booking_form">
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" name="name" id="name" type="text" placeholder="Name" required>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" name="email" type="email" id="email" placeholder="Email" required>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<!-- <input type="hidden" name="mobile" id="mobile_code"> -->
								...
								<!-- <div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control" id="Password" name="Password" type="text" placeholder="Password" minlength="6" maxlength="15">
					...
					<div class="modal-footer">
						...
						<button class="btn ripple btn-success" id="smallmodal" type="button" onclick="saveformNew()">Create <?= $addName; ?></button>
...
<script>
	...
	function viewtable() {
		...
		var table = $('#manualtickettable').DataTable();
...
// },
...

							{
								...
								render: function(data, type, row) {
									...
									$output += '<div class="g-2">';

									$output += '<a target="_blank" href="<?= $baseurl; ?>invoice/' + data.transaction_id + '" class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="View Receipt"><span class="fa fa-file-text-o fs-14"></span></a>';

									$output += '<a target="_blank" href="<?php echo $baseurl; ?>ticket-view/' + data.transaction_id + '" class="btn text-secondary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="View Tickets"><span class="fa fa-files-o fs-14"></span></a>';

									$output += '<button value="' + data.transaction_id + '" onclick="deleteticket($(this).val())" class="btn btn-danger edit"><span class="fe fe-trash-2 fs-14"></span></button>';

									// $output += '</div>';

									// $output += '<button value="' + data.transaction_id + '"  class="btn btn-danger edit"><span class="fa fa-pencil-square-o fs-14"></span></button>';
	...
	function saveformNew() {
		...
		if (tabID == 'offline-ticket') {

			c = true;

		} else {

			c = (pass.length >= 6 && tabID != 'offline-ticket');
	...
	function sendotp() {
		...
		if (pass.value.length >= 6) {
			...
			// $('#mobile_code').val(country + mobilenumber);
			...
			var onsuccess = function(data) {
				...
				if (response != "") {
					...
					if (response.type == 1) {
						...
						document.getElementById('title').innerText = response.Newmobile;
