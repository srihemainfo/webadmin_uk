                                    ...
                                    <div class="row g-2 mb-2">
                                        ...
                                        <div class="col-6">
                                            <select class="form-select form-select-sm shadow-none" id="gdFilterCab">
                                                ...
                                                <option value="go 4seater">Go 4Seater</option>
...
`;
    ...
    <div class="card mb-2 shadow-sm border-0">
      <div class="card-body p-3 ${job.global_type == 'open' && !isInactive ? 'card-open' : ''}">
        ...
        <a href="javascript:void(0)" 
           class="text-info ms-2 viewPushStatusBtn" 
           title="View Push Delivery Status"
           data-jobid="${job.id}"
           data-jobno="${job.job_no || job.title}">
            <i class="fa fa-bell text-warning" style="font-size: 16px;"></i>
        </a>
        ` : ''}
        </div>
    ...
    // First API Call: Existing not_complete jobs
    let req1 = $.ajax({
    ...
    // Second API Call: New scheduled jobs
    let req2 = $.ajax({
    ...
    $.when(req1, req2).done(function(res1, res2) {
        // res1 and res2 are arrays in $.when: [data, textStatus, jqXHR]
        let data1 = res1[0];
        let data2 = res2[0];
        ...
        // Normalize and push to unassignedJobs object
