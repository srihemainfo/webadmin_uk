					...
					<div class="card">
						...
						<div class="card-header">
							...
							<div class="col-sm">
								...
								<button type="button" id="smallmodal" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#addagent" style="float: right;" class="btn btn-info"><i class="fa fa-user-plus me-2"></i>Add User</button>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" id="name" name="name" maxlength="50" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '');" type="text" placeholder="Full Name" required>
								...
								<div class="wrap-input100 validate-input input-group">
									<a href="javascript:void(0)" class="input-group-text bg-white text-muted"><i class="mdi mdi-account" aria-hidden="true"></i></a>
									<input class="input100 border-start-0 ms-0 form-control req-empty" name="lname" id="lname" maxlength="50" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '');" type="text" placeholder="Last Name" required>
								</div>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" id="email" maxlength="25" name="email" type="email" placeholder="Email" required>
	...
	function viewtable() {
		...
		if (datefrom == '' || datefrom != '' || datefill != '' || datefill == '' || fieldname != '' || deletedstatus != '' || deletedstatus == '') {
			...
			if (tabID == 'agents') {
				...
				// 	var excelTitle = 'My Customer List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + ' to ' + datefill + ')';
				//    }
				//    else if(fieldname != '' || deletedstatus != '' ){
				// 	var excelTitle = 'My Customer List Reports : (' + fieldname + ' ' + deletedstatus + ')';
