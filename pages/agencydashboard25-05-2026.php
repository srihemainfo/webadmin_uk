            ...
            <div class="mt-2 row small text-muted">
                <div class="col-6">
                    <div class="d-flex align-items-center mb-1">
                        ...
                        ${(!isInactive && job.app_source !== 'Website Job' && job.app_source !== 'Driver App' && job.source !== 'website') ? `<i class="fa fa-comment-dots text-primary cursor-pointer send-push-icon me-2" title="Send Push Notification" data-userid="${job.user_id}" data-name="${job.name}" style="font-size: 13px;"></i>` : ''}
                        ...
                        ${(
    job.job_status &&
    ['accept', 'accepted','completed'].includes(job.job_status.toLowerCase())
) 
    ? (
        job.is_verified == 1
        ? `
