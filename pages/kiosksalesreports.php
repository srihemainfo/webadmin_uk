 ...
 *  21/8/23           divya                        search bar for kioskid
 */
					...
					<div class="card-header row">
						...
						<div class="row align-items-center">
                            ...
                            <div class="col-lg-4 col-md-8  mb-2">
                                            <span>Search Kiosk ID </span>
                                            <input class="form-control" type="text" oninput="viewtable()" id="searchTxt" placeholder="Kiosk id ">
                                        </div>
...
<script id="rendered-js">
	...
	function viewtable() {
		...
		let fileName = 'Kiosk Tickets Report';
