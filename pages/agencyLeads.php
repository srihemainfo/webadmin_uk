                                        ...
                                        <div class="tab-pane active" id="tab1">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered text-nowrap border-bottom"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th class="column_sort sorting sorting_asc">plt</th>
                                                            ...
                                                            <th class="column_sort sorting sorting_asc">Location</th>
                ...
                columns: [
                    ...
                    // },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if (!data?.ready_to_revolutionize_your_fleet) return '';
                            return data.ready_to_revolutionize_your_fleet;
                        }
                    },
                    {
                        data: null,
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return data.full_name.replace(/\D/g, '');
                        }
                    },
                    {
                        data: null,
                    ...
                    // }
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `
                                ...
                                <i class="fab fa-whatsapp text-success fa-2x cursor-pointer" title="Send WhatsApp" onclick="openWhatsApp('${row.id}', this, '${row.full_name}')"></i>
                            `;
                        }
                    },
                    // {
    ...
    function wh_log_form(id, btn) {
        if (id != '') {
            ...
            $.ajax({
                ...
                dataType: "json",
                data: {
                    method: 'wh_log_details',
                    id: id,
                },
                success: function(response) {
                    let rows = '';
                    // The service returns data in response.result
    ...
    function sendWhatsApp(btn){
        ...
        if(what_id != '' && ph != '' && template_id != ''){
            ...
            $.ajax({
                ...
                method: "POST",
                data: { method: 'get_single_template_agency',id: template_id, mess: message, a_id: what_id },
