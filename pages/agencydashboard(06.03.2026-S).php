                        ...
                        <div class="edit-mode" id="edit-driver-profile" style="display: none;">
                            <div class="row g-2">
                                <div class="col-5">
                                    ...
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_name"
                                        data-field="name" value="Venkatesan">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Age</label>
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_age"
                                        data-field="age" value="35">
                                </div>
                                <div class="col-4">
                                    <label class="form-label fw-semibold mb-1">Mobile</label>
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_mobile"
                                        data-field="mobile" value="9876543210">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Email</label>
                                    <input type="email" class="form-control form-control-sm edit-field" id="edit_email"
                                        data-field="email" value="driver@mail.com">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Driver Exp *</label>
                                    <input type="number" class="form-control form-control-sm" id="edit_experience"
                                        value="5">
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_state"
                                        data-field="state" value="Tamil Nadu">
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-semibold mb-1">Address</label>
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_address"
                                        data-field="address" value="123, Anna Salai, T. Nagar, Chennai - 600017">
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-semibold mb-1">Languages</label>
                                    <select class="form-select form-select-sm edit-field" id="edit_languages"
                                        data-field="languages" multiple size="2">
                                ...
                                <div class="edit-mode" id="edit-vehicle" style="display:none;">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="edit_seating"
                                                value="4+1">
                                        </div>
                                        <!-- Row 3 -->
                                        <div class="col-4">
                                            <label class="form-label fw-semibold">Luggage</label>
                                            <input type="text" class="form-control form-control-sm" id="edit_luggage"
                                                value="2">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">RC Valid Until</label>
                                            <input type="date" class="form-control form-control-sm" id="edit_rc">
                                        </div>
                                        <!-- Row 4 -->
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">Insurance Valid Until</label>
                                            <input type="date" class="form-control form-control-sm" id="edit_insurance">
                                        </div>
                                        <!-- Buttons -->
        ...
        function openDriverEditDrawer(id) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    // State
                    setText('[data-field="state"]', d.state);
                    ...
                    /* =========================
                       AADHAAR
                    ========================== */
                    if (d.proof_type === 'AADHAR_DIGILOCKER') {
    ...
    <div class="d-flex align-items-center gap-2">
            ...
            switch (section) {
                case 'driver-profile':
                    data = {
                        ...
                        exp: $('#edit_experience').val(),
                        languages: $('#edit_languages').val()?.join(','),
                        upiID: $('#edit_upi').val()
                    };
                    break;
                case 'remarks':
                ...
                case 'vehicle':
                    data = {
                        ...
                        maker_model: $('#edit_maker_model').val(),
                        fuel: $('#edit_fuel').val(),
                        seating: $('#edit_seating').val(),
                        luggage: $('#edit_luggage').val(),
                        rc_expiry: $('#edit_rc').val(),
                        insurance_expiry: $('#edit_insurance').val()
                    };
                    break;
            }
            return data;
        ...
        $(document).on('click', '.save-section', function() {
            ...
            $.ajax({
                ...
                data: getSectionData(section, driverId),
                success: function(res) {
                    if (res.status) {
