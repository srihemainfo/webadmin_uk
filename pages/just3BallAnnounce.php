...
//30-01-2023    Sathiya       new email tempalte function change in new ajax apge ,1.page_name(winners_email.php)
...
if ($subid3 != '') {
	...
	$draw = select_query($con, "draw", "", "`id`= '$subid3' AND `deletes` = '0' ORDER BY `id` DESC LIMIT 1", "", "");
	if ($draw['nr'] > 0) {
		$status = $draw['result'][0]['status'];
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Just3 Ball - Announce</h1>
				...
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Just3 Ball - Announce</li>
			...
			<!-- <div class="row">
				...
				<div class="col-md-12">
					<div class="card  ">
						...
						<div class="card-body">
							<div class="card bg-light1  p-3">
								<div class="row  align-items-center">
									<div class="col-10">
										<h4>Admin</h4>
										<small>25th Aug 2023, 11:16:34 am</small>
										<p class="pt-2">Dear Reviewer,

											I have updated, kindly announe</p>
									</div>
									<div class="col-2"><button class="btn  bg-secondary-gradient text-white"> View more</button></div>
								</div>
							</div>
				...
				<div class="col-md-4">
					...
					<div class="card text-center bg-success-gradient">
						...
						<div class="card-body">
							...
							<h1 class="card-title" style="color: white;">1<sup>st</sup>Prize (Straight)</h1>

							<h3 class="card-text" style="color: white;font-size: 40px;"> <?= $draw['result'][0]['first']; ?></h3>
				...
				<div class="col-md-4">
					...
					<div class="card text-center bg-info-gradient">
						...
						<div class="card-body">
							...
							<h1 class="card-title" style="color: white;">2<sup>nd</sup> Prize (Reverse)</h1>

							<h3 class="card-text" style="color: white; font-size: 40px;"> <?= $draw['result'][0]['second']; ?></h3>
				...
				<div class="col-md-4">
					...
					<div class="card text-center bg-warning-gradient">
						...
						<div class="card-body">
							...
							<h1 class="card-title" style="color: white;">3<sup>rd</sup>Prize (Mixed)</h1>

							<h4 class="card-text" style="color: white; font-size: 35px;"> <?= $draw['result'][0]['third_one'] . ',' . $draw['result'][0]['third_two'] . ',' . $draw['result'][0]['third_three'] . ',' . $draw['result'][0]['third_four']; ?></h4>
					...
					<div class="card">
						...
						<div class="row" style="align-items: center;">
							...
							<div class="card-header d-block">
								...
								<div style="float: left;">
									...
									<h3 class="card-title">Winning Announcement List</h3>
						...
						<div class="card-body">
							...
							<div class="col-sm col-lg-12 mt-3 d-flex justify-content-between" id="actionBTN">
								<?php
								if ($subid2 != 'list') {
									if ($status == 'Active' && $draw['result'][0]['just3_ball_review'] == 'Submitted') { ?>
									...
									<?php } ?>
									<?php if ($status == 'Active' && $draw['result'][0]['just3_ball_review'] == 'Submitted') { ?>
...
<script>
	...
	var mailurl = origin + "/ajax/service/just3winners_email.php";
	...
	function viewtable() {
		...
		if (tabid == 'list_draw_winner') {
			var title = 'Winner List';
			table = $("#winnersdatble").DataTable({
				destroy: true,
				pageLength: 10,
				...
				ajax: {
					...
					url: origin + "/ajax/service/just3winners_email.php",
				...
				initComplete: function() {
					// This function will run after data loading is complete
