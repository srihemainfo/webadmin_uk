            ...
            <div class="tab-content" id="dashboardTabsContent">
                ...
                <div class="tab-pane fade" id="customer-pane" role="tabpanel" aria-labelledby="customer-tab">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card shadow-sm border-start border-4 h-80" style="border-color: #6f42c1;">
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="fw-bold mb-0 cursor-pointer" style="color: #6f42c1; font-size: 15px;" onclick="window.location.href='/car-pool/kyc'">
                                            <i class="bi bi-person-vcard-fill me-1"></i> Carpool KYC
                                        </h6>
                                    ...
                                    <div class="mb-3 mt-2 d-flex align-items-center cursor-pointer" onclick="window.location.href='/car-pool/kyc'">
                                        <span class="text-muted fw-semibold me-2" style="font-size: 14px;">Total Received :- </span>
                                        <span id="ckyc_total" class="text-dark" style="font-size: 26px; font-weight: 900; line-height: 1;">0</span>
                                    </div>
                                    <div class="d-flex flex-wrap gap-3">
                                        <div class="job-stat-item job-stat-link" style="min-width: 25%;" onclick="window.location.href='/car-pool/kyc'">
                                            Verified:<span id="ckyc_verified" class="job-stat-val text-success fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="min-width: 25%;" onclick="window.location.href='/car-pool/kyc'">
                                            Pending:<span id="ckyc_pending" class="job-stat-val text-warning fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="min-width: 25%;" onclick="window.location.href='/car-pool/kyc'">
                                            Rejected:<span id="ckyc_rejected" class="job-stat-val text-danger fw-bold ms-1">0</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function fetchCarpoolKycSummary(startDate, endDate) {
            $.ajax({
                ...
                success: function(res) {
                    if (res.type == 1) {
                        $('#ckyc_total').text(res.data.total);
                        $('#ckyc_verified').text(res.data.verified);
                        $('#ckyc_pending').text(res.data.pending);
                        $('#ckyc_rejected').text(res.data.rejected);
                    }
                },
                error: function(xhr, status, error) {
