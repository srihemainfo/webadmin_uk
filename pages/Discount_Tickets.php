   ...
   <div class="side-app">
      <div class="main-container container-fluid">
         <div class="page-header">
            <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Discount Tickets</h1>
            <div>
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="" id="anchor">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Discout Tickets</li>
               </ol>
            </div>
         </div>
      </div>
               ...
               <div class="card-header">
                  <div class="row">
                     ...
                     <div class="col-md-10   col-lg-4  mb-2">
                      ...
                      <div class="col-md-10   col-lg-4  mb-2">
                                    <span>Search </span>
                                    <input class="form-control" type="text" oninput="viewtable($(this).val())" id="searchTxt" placeholder=" Coupon Code / name / mobil / email">
                     ...
                     <table class="table table-bordered text-nowrap border-bottom" id="wtickettable" style="width:100%;">
                        <thead>
                           <tr>
                              ...
                              <th class="wd-20p border-bottom-0">Event Name</th>
...
var Dis_id = currentPageUrl.split('/').pop();
// alert(id);
if(Dis_id != ''){
    Discout_id = Dis_id;
}else{
...
viewtable();
   ...
   function viewtable() {
    ...
    var title = 'Discout Ticket Reports : (' + formdate + '  to  ' + todate + ')';
    ...
    var table = $("#wtickettable").DataTable({
      ...
      ajax: {
        ...
        dataSrc: "",
        data: {
          method: 'list_Discountticket',
          formdate: formdate,
          todate: todate,
          couponid: couponid,
          search_id: search_id,
          Discout_id: Discout_id,
        },
      },
      dom: 'Bfrtip',
      buttons: [{
