                                    ...
                                    <div class="card h-100" id="mapCard">
                                        <div class="card-body p-0">
                                            <div id="driversMapWrapper" style="position:relative; height:600px;">
                                                <div
                                                    style="position: absolute; top: 15px; left: 55px; z-index: 1000; display: flex; gap: 10px; align-items: start;">
                                                    <div style="position: relative; width: 300px; flex-shrink: 0;">
                                                        <div class="input-group bg-white"
                                                            style="border-radius: 6px; box-shadow: 0 2px 6px rgba(0,0,0,0.15); overflow: hidden; height: 38px;">
                                                            <span
                                                                class="input-group-text bg-white border-0 text-secondary"
                                                                style="padding-left: 12px; padding-right: 5px;">
                                                                <i class="fa fa-search"></i>
                                                            </span>
                                                            <input type="text" id="mapDriverSearch"
                                                                class="form-control border-0 shadow-none h-100"
                                                                placeholder="Search Driver by Name or Phone"
                                                                autocomplete="off"
                                                                style="font-size: 13px; padding-left: 5px; outline: none; box-shadow: none;">
                                                        </div>
                                                        <div id="mapDriverSearchResults"
                                                            class="list-group position-absolute w-100 d-none"
                                                            style="max-height: 350px; overflow-y: auto; top: 100%; left: 0; background: white; border-radius: 6px; margin-top: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.15); border: 1px solid #dee2e6;">
                                                        </div>
                                                    </div>
                                                    <div id="historyControls" class="bg-white shadow-sm"
                                                        style="border-radius: 6px; box-shadow: 0 2px 6px rgba(0,0,0,0.15); overflow: hidden; display: flex; align-items: center;">
                                                        <div class="input-group" style="height: 38px;">
                                                            <span
                                                                class="input-group-text bg-white border-0 text-primary">
                                                                <i class="fa fa-calendar-alt"></i>
                                                            </span>
                                                            <input type="text" id="historyDateRange"
                                                                class="form-control border-0 shadow-none fw-semibold h-100"
                                                                placeholder="Select Date & Time Range"
                                                                style="font-size: 12px; width: 250px; cursor: pointer; background: #fff; padding-left: 0; outline: none; box-shadow: none;"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div id="routeDriverFilterWrapper" class="bg-white shadow-sm d-none"
                                                        style="border-radius: 6px; box-shadow: 0 2px 6px rgba(0,0,0,0.15); overflow: hidden; display: flex; align-items: center;">
                                                        <select id="routeDriverFilter"
                                                            class="form-select border-0 shadow-none fw-bold text-dark"
                                                            style="font-size: 13px; height: 38px; cursor: pointer; outline: none;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="bidTollFare" value="90">
                <div class="mb-3">
