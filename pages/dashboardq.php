        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        ...
                                        <h2 class="mb-0 number-font" id="totalonline">AED <?php echo intval($totalAmount); ?></h2>
                                        <?php
                                        // Loop through and display AED amount for each product
                                        foreach ($productAmtArray as $productAmt => $totalAmt) {
                                            echo '<p class="aed-agent">AED ' . $productAmt . ' - ' . $totalAmt . ' </p>';
                                        }
                                        ?>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                        <!-- Agent Ticket Section -->
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="mt-2">
                                        <h6 class="">Agent Ticket</h6>
                                        <h2 class="mb-0 number-font" id="totalagent">AED <?php echo intval($totalAmount); ?></h2>
                                        <?php
                                        // Loop through and display AED amount for each product
                                        foreach ($productAmtArray as $productAmt => $totalAmt) {
                                            echo '<p class="aed-agent">AED ' . $productAmt . ' - ' . $totalAmt . ' </p>';
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Signups & Logins (Last 7 Days)</h4>
                            </div>
                            <div class="card-body">
