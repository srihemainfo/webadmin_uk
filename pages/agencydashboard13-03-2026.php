...
================================ */
    ...
    .document-box-small {
        width:100%;
    height:110px;            /* Aadhaar card proportion */
    border-radius:6px;
    overflow:hidden;
                ...
                <div class="d-flex align-items-center gap-3 mt-3">
                    ...
                    <img src="/assets/images/driver.png" alt="Driver Photo" id="preview_driver_photo"
                       ...
                       style="height: 100%;width: 100%; object-fit: cover;"
                        data-bs-toggle="modal" data-bs-target="#driverPhotoModal"></div> 
                    <div class="w-100">
        ...
        function openDriverEditDrawer(id) {
            ...
            ========================== */
                    if (d.proof_type === 'AADHAR_DIGILOCKER' && d.proof_status === 'approved') {
                        ...
                        // Show DigiLocker badge in Edit Mode too
                        $('#edit-aadhaarFront img').attr('src', '/assets/images/digiverify.png').show();
                        $('#edit-aadhaarBack img').attr('src', '/assets/images/digiverify.png').show();
                    } else {
                        ...
                        // Show actual uploaded images in Edit Mode
                        if (d.aadhar_image_front) {
                            $('#edit-aadhaarFront img').attr('src', d.aadhar_image_front).show();
                        }
                        if (d.aadhar_image_back) {
                            $('#edit-aadhaarBack img').attr('src', d.aadhar_image_back).show();
                        }
                    }
                    /* =========================
                       LICENSE / RC
                    ...
                    /* =========================
                       SECTION COMPLETION TICKS (SAFE ISOLATED MODE)
                    ========================== */
                    /* =========================
...
========================== */
                    ...
                    canvas.show();
                    // This loadDriverSchedule handles the scheduled jobs yellow/green icon check
...
<script>
    ...
    function updateSectionIcons(d, vehicleData) {
        const isSet = (val) => val && String(val).trim() !== '' && String(val).trim() !== 'N/A' && String(val).trim() !== '-' && String(val).trim() !== 'null';
        ...
        if (isSet(rcExpiry)) docScore += 3;
        if (isSet(insExpiry)) docScore += 3;
        if (isSet(pucExpiry)) docScore += 3;
