...
$pageTitle = "Future Participation List";
    ...
    $(document).ready(function() {
        $('#drawtype').change(function() {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    method: 'Feature_participation_list_search',
                    drawType: drawType
                    ...
                    if (response != "") {
                        if (response.type == '1') {
                            ...
                            response.drawList.forEach(function(value, index) {
                                ...
                                let drawNo = value[(drawType === 'Daily_Thrill' ? 'Thrill_DrawNo' : (drawType === 'Weekly_Raffle' ? 'weeklyDrawNo' : (drawType === 'Month_Bumper' ? 'bumperDrawNo' : '')))] || '';
    ...
    function winnerList() {
        ...
        var table = $('#Participation_List').DataTable({
            ...
            ajax: {
                ...
                dataSrc: "userList",
                data: {
                    method: 'feature_participation_list',
                    draw_id: draw_new_id,
                    drawtype: drawtype,
