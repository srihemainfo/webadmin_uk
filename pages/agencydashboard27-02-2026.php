                                ...
                                <div class="edit-mode" id="edit-vehicle" style="display:none;">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="edit_rc"
                                                value="30 Nov 2026">
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="edit_insurance"
                                                value="15 Aug 2027">
                                        </div>
        ...
        function openDriverEditDrawer(id) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    setText('#display_vehicle_type', vehicleData.type);
                    setVal('#edit_vehicle_type', vehicleData.type);
...
$(document).on('click', '.manageBidBtn', function() {
  ...
  <div class="border  p-3 ">
    ...
    $(document).ready(function () {
        ...
        // Save button - update data and return to view mode
        $('.save-section').on('click', function (e) {
            ...
            `);
                ...
                // Parse activities (simple split - in real app would be more structured)
...
<script>
    ...
    // Store a reference to the card that contains the clicked button
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if (res.status) {
                        ...
                        reloadJobsWithFilter(); // Refresh lists to show green badge
                    } else {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status) {
                        // Show success message then remove the card
                        Swal.fire({
                            icon: 'success',
                            title: 'Cancelled!',
