 ...
 * 18-8-2023    Divya          Kiosk Ticket has been added
 */
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered display" id="ticket_wise_report" style="width:100%;">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-20p border-bottom-0">Total Amount (AED)</th>
    ...
    <script>
        ...
        function search_wise_Ticket() {
            ...
            if (draw_new_id != '') {
                ...
                var title = 'Ticket Reports - ( ' + $('#draw_new_id option:selected').text() + '  ' + ticket_name + '  ' + agdate + ' )';
