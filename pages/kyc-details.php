                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="column_sort sorting sorting_asc">Selfie</th>
                                                            <th class="column_sort sorting sorting_asc">Selfie Status</th>
                                                            <th class="column_sort sorting sorting_asc">Proof Type</th>
                                                            <th class="column_sort sorting sorting_asc">Proof</th>
                                                            <th class="column_sort sorting sorting_asc">Proof Status</th>
                                                            <th class="column_sort sorting sorting_asc">DL</th>
                                                            <th class="column_sort sorting sorting_asc">DL Status</th>
