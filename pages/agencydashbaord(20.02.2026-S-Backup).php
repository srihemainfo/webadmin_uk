                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                <div class="col-12" id="rightPanel"> <!-- CHANGED: from col-lg-6 to col-12 -->
                                    ...
                                    <!-- Row for detail cards - they will appear side by side when visible -->
                                    <div class="row mt-3"> <!-- ADDED: row for detail cards -->

                                        <!-- Driver Details Card - takes half width -->
