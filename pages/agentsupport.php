 ...
 * 25-9-2023     Divya          customer support login completed
 * 25-9-2023     Divya          customer support login with customer page completed
...
}else if ($tabID == 'affiliate-referral') {



	$title = 'Affiliate Refferal';



	$idname = 'Affiliate Refferal ID';



	$addName = 'Affiliate Refferal';

} else if ($tabID == 'support') {



	$title = 'support Refferal';



	$idname = 'support Refferal ID';



	$addName = 'support Refferal';
...
<div class="main-content app-content mt-0">
								...
								<div class="mt-2">
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<input type="text" name="fieldname" id="fieldname" value="" class="form-control">
	...
	<?php if ($tabID == 'customersupport') { ?>
											...
											<th class="wd-20p border-bottom-0">Winning Balance</th>
											...
											<?php if ($tabID == 'customersupport') { ?>
												...
												<th class="wd-25p border-bottom-0">Cash Points</th>

													<th class="wd-25p border-bottom-0">Bonus Points</th>
...
<?php if ($tabID == 'affiliate-referral') { ?>
											<th class="wd-25p border-bottom-0">User refferal link</th>
<?php } ?>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<?php if ($tabID != 'customersupport') { ?>
									...
									<label class="lb-text">Password&nbsp;<sup style="color: red;weight: bolder;">*</sup></label><br>
...
<script id="rendered-js">
	...
	function viewtable() {
		...
		if (datefrom == '' || datefrom != '' || datefill != '' || datefill == '' || fieldname != '' || deletedstatus != '' || deletedstatus == '') {
			...
			if (tabID == 'agents') {
				...
				var excelTitle = 'My Agent List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + ' to ' + datefill + ')';
			...
			} else if (tabID == 'customersupport') {

				var excelTitle = 'My Customer List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + '  ' + datefill + ')';
...

	{
				...
				var excelTitle = 'My Staffs List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + '  ' + datefill + ')';
				...
				var excelTitle = 'Customer support List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + '  ' + datefill + ')';
				...
				var excelTitle = 'Affiliate List Reports : (' + fieldname + ' ' + deletedstatus + ' ' + datefrom + '  ' + datefill + ')';
				...
				var excelTitle = "Affiliate User List";
	...
	function sendotp() {
		...
		if (tabID == 'customersupport') {
			...
			c = (pass.length >= 6 && tabID != 'customersupport');
