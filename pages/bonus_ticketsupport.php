...
//  04-03-2023   sathiya             table value changes completed
...
.dt-buttons.btn-group.flex-wrap{position:initial;float:left}div.container{width:80%}#showerroralert,#showsuccessalert{display:none}form.datefilter{float:right}button,input{height:35px;margin:0;padding:6px 12px;border-radius:2px;font-family:inherit;font-size:100%;color:inherit;border:1px solid #ccc}button{color:#fff;background-color:#428bca;border:1px solid #357ebd}textarea{width:100%;height:150px;padding:12px 20px;box-sizing:border-box;border:2px solid #ccc;border-radius:4px;background-color:#f8f8f8;font-size:16px;resize:none}.back-arrow-btn i{background:#fff;font-size:16px;padding:2px 3px;border-radius:50px;border:2px solid #6c6e70;color:#6c6e70;margin-right:15px;width:24px;height:24px}.pd-20{padding:0 37px 0 0}button.btn-style{background:#1170e4;padding:4px;height:38px;border:#ffdead;color:#fff;border-radius:7px;width:38px;margin:38px 0 0 5px}button.btn-style1{background:#1170e4;padding:2px;height:29px;border:#ffdead;color:#fff;border-radius:7px;width:42px;margin:5px 5px 0 4px}div#enternewticketlines select{padding:.475rem .75rem;font-size:.875rem;border-radius:7px;margin-top:9px}
...
window.onload=function(){var n=window.location.origin;document.getElementById("anchor").href=n};
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Bonus Tickets</h1>
				...
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Bonus Tickets</li>
	...
	function viewtable() {
		...
		order: [
                        ...
                        columnDefs: [
                              ...
                              { type: 'date', targets: [7] } // Assuming the date column is at index 2
...
// 		couponid = '';
	...
	function deletebpticket(trans_id) {
        ...
        $('#delete_btn').html(`<button class="btn ripple btn-danger" onclick="confirmbpDelete('${trans_id}', $('#deletemessage').val())" type="button">Submit</button>`);
	...
	function confirmbpDelete(id, Dmessage) {
