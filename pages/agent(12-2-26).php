                        ...
                        <div class="mt-2">
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-3">
                                 ...
                                 <input type="text" name="fieldname" id="fieldname" oninput="viewtable($(this).val())" class="form-control" placeholder="Phone/ Name / email">
                              </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="exampleTable" style="width:100%;">
                           <thead>
                              <tr>
                                 ...
                                 <?php if ($tabID != 'support') { ?>
                                 <!--<th class="wd-20p border-bottom-0">wallet Balance</th>-->
                                 <?php } ?>
         ...
         <div class="cls_form_div">
            <form class="login100-form validate-form cls_booking_form">
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <label class="lb-text">First Name&nbsp;<sup style="color: red;weight: bolder;">*</sup></label><br>
                        <div class="wrap-input100 validate-input input-group">
                           ...
                           <input class="input100 border-start-0 ms-0 form-control req-empty" id="name" name="name" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '');" type="text" placeholder="First Name" required>
                        </div>
                        ...
                        <label class="lb-text">Date of Birth&nbsp;<sup style="color: red; weight: bolder;">*</sup></label><br>
                        <div class="wrap-input100 validate-input input-group">
                            <a href="javascript:void(0)" class="input-group-text bg-white text-muted">
                                <i class="fa fa-calendar" aria-hidden="true"></i>
                            </a>
                            <input type="date" value="<?= $row['date_of_birth']; ?>" name="dob" class="form-control" id="dob" placeholder="Date of Birth">
                        </div>

                        
                        <label class="lb-text">Mobile No&nbsp;<sup style="color: red;weight: bolder;">*</sup></label><br>
                        <div class="wrap-input100 validate-input input-group">
                           <input id="phone" type="tel" oninput="mobile_number_validation($(this).val())" onfocusout="Email_check()" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="15" required>
                        ...
                        <div class="wrap-input100 validate-input input-group">
                           ...
                           <input class="input100 border-start-0 ms-0 form-control req-empty" id="email" name="email" type="email" placeholder="Email" >
                        </div>
                        ...
                        <div class="wrap-input100 validate-input input-group">
                           <div class="form-group" style="width: 100%;" id="gfhdjkdk">
                              ...
                              <div class="disc-pot">
                                 ...
                                 <select class="form-control form-select selectpicker" data-live-search="true" id="nationlaity" name="nationlaity" required>
                        ...
                        <div class="wrap-input100 validate-input input-group">
                           <div class="form-group" style="width: 100%;" id="gfhdjkdk">
                              <label class="lb-text">Country of Residence&nbsp;<sup style="color: red;weight: bolder;">*</sup></label>
                              <div class="disc-pot">
                                 <select class="form-control form-select selectpicker" data-live-search="true" id="residinglocation" name="residinglocation" required>
                                    <option value="">Select Country</option>
                                    <?php
                                       $countries = mysqli_query($con, "SELECT `countries`.`id` AS `id`, `countries`.`name` AS `name`, COUNT(states.id) AS `statecount` FROM `countries` INNER JOIN `states` ON `countries`.`id` = `states`.`country_id` WHERE `countries`.`flag` = '1' GROUP BY countries.id HAVING `statecount` > 0 ORDER BY name ASC;");
                                       while ($value = mysqli_fetch_array($countries)) : ?>
               ...
               <div class="modal-footer">
                  <div id="rebtn">
                     <button class="btn ripple btn-success" id="smallmodal1" type="button" onclick="sendotp()">Create <?= $addName; ?></button>
                  </div>
               </div>
            </form>
         </div>
