                                                ...
                                                <table class="table table-bordered text-nowrap border-bottom"
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <!--<th class="column_sort sorting sorting_asc">Subscription ID</th>-->
                                                            ...
                                                            <th class="column_sort sorting sorting_asc">Comment</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            const websiteIcon = row.gentral_setting_count > 0 
                                ? '<i class="fas fa-check-square" style="color: green;"></i>' 
                                : '<i class="fas fa-times-circle" style="color: red;"></i>';
                            ...
                            return `
                                <div>
                                    ...
                                    ${vehicleIcon} Vehicle Creation <br>
                                    ${websiteIcon} Website Creation
                                </div>
                            `;
                        }
                    },
                    ...
                    // }
                    {
                        ...
                        render: function (data, type, row, meta) {
                            return `
                                    <div class="marquee-wrapper" data-bs-toggle="tooltip" title="Lorem asd dsf dsf ijbasfd ibas gsfddsf.">
                                      <p class="marquee-text m-0">Lorem asd dsf dsf ijbasfd ibas gsfddsf.</p>
                                    </div>
