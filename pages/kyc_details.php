                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-3 col-lg-3">
                                            ...
                                            <select class="form-control" id="kyc_filter">
                                                ...
                                                <option value="k_n_v">KYC pending</option>
                                                <option value="k_r">KYC rejected</option>
                                                <option value="k_v">KYC verifed</option>
                                                <option value="v_n_c">Vehicle not completed</option>
                                                <!--<option value="v_n_v_n">Vehicle not verified</option>-->
                                                <option value="v_n_v">Vehicle pending</option>
                                                <option value="v_r">Vehicle rejected</option>
                                                <option value="v_v">Vehicle verifed</option>
                                                <option value="na_p">Nameboard Pending</option>
                                                <option value="na_v">Nameboard Verified</option>
                                                <option value="na_r">Nameboard Rejected</option>
                                                <option value="both_i">Both verifed (Individual)</option>
                                                <option value="both_c">Both verifed (Company)</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-12 col-md-3 col-lg-3">
                                            <span>Select filter</span>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="tab-menu-heading border-0 p-0 mb-3">
                                    <ul class="nav nav-tabs nav-tabs-line" id="userTabs" role="tablist">
                                        ...
                                        <!--<li class="nav-item" role="presentation">-->
                                        <!--  <button class="nav-link" id="kyc-tab" data-type="kyc_pending" data-bs-toggle="tab"-->
                                        <!--    type="button" role="tab">-->
                                        <!--    <i class="fa-solid fa-id-card me-1 text-primary"></i> KYC Pending-->
                                        <!--  </button>-->
                                        <!--</li>-->
                                        <!--<li class="nav-item" role="presentation">-->
                                        <!--  <button class="nav-link" id="vehicle-tab" data-type="vehicle_pending" data-bs-toggle="tab"-->
                                        <!--    type="button" role="tab">-->
                                        <!--    <i class="fa-solid fa-car-side me-1 text-warning"></i> Vehicle Pending-->
                                        <!--  </button>-->
                                        <!--</li>-->
                                        <!--<li class="nav-item" role="presentation">-->
                                        <!--  <button class="nav-link" id="kyc_reject-tab" data-type="rejected_kyc" data-bs-toggle="tab"-->
                                        <!--    type="button" role="tab">-->
                                        <!--    <i class="fa-solid fa-car-side me-1 text-warning"></i> KYC Reject-->
                                        <!--  </button>-->
                                        <!--</li>-->
                                        <!--<li class="nav-item" role="presentation">-->
                                        <!--  <button class="nav-link" id="vehicle_reject-tab" data-type="rejected_vehicle" data-bs-toggle="tab"-->
                                        <!--    type="button" role="tab">-->
                                        <!--    <i class="fa-solid fa-car-side me-1 text-warning"></i> Vehicle Reject-->
                                        <!--  </button>-->
                                        <!--</li>-->
                                        <!--<li class="nav-item" role="presentation">-->
                                        <!--  <button class="nav-link" id="verified-tab" data-type="verified" data-bs-toggle="tab"-->
                                        <!--    type="button" role="tab">-->
                                        <!--    <i class="fa-solid fa-circle-check me-1 text-success"></i> Verified Users-->
                                        <!--  </button>-->
                                        <!--</li>-->
                                    </ul>
                                </div>
                                <div class="panel-body tabs-menu-body border-0 pt-0">
                                    <div class="table-responsive">
                                        ...
                                        <table id="Participation_List" class="table table-striped d-none">
                                            <thead>
                                                <tr>
                                                    <th>created_at</th>
                                                    <th>name</th>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea id="com_message" class="form-control" rows="3"
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-center align-items-center">
                <img id="previewImage" src="" alt="Preview" class="img-fluid shadow"
...
<div class="modal fade" id="confirmUnblockModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body">
                <p class="mb-0">Are you sure you want to <strong>unblock</strong> this user? They will regain full
                    access to their account immediately.</p>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body p-4">
                    ...
                    <table class="table table-hover table-bordered table-sm text-start" style="text-align: left !important;">
                        <thead class="table-light sticky-top">
                            <tr>
                                ...
                                <th scope="col" width="30%">Contacted Person</th>
                ...
                <div class="row">
                    <div class="col-12">
                        <textarea id="new_remark_text" class="form-control" rows="3" placeholder="Type your remarks here..." style="text-align: left !important;"></textarea>
                    </div>
                </div>
                <div class="row mt-3">
...
<script>
            ...
            const table = $('#Participation_List').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    data.each(function(item) {
                        ...
                        const profileImg = item.selfie_url ||
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            <div class="user-card rounded-4 p-3 bg-white h-100 d-flex flex-column">
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div>
                                        <h6 class="fw-bold mb-1 text-truncate d-flex align-items-center gap-2" title="${item.name || 'No Name'}">
                                            ${item.name || 'No Name'}
                                            <i class="fa-solid fa-message cursor-pointer" style="font-size: 1.1rem; color: #6c757d;" onclick="openRemarksModal('${item.user_id}', '${item.name || 'User'}')" title="Add/View Remarks"></i>
                                        </h6>
                                ...
                                <!-- Actions -->
                                <div class="mt-auto pt-3 border-top justify-content-around d-flex">
                                  <div class="action-icon text-center position-relative" title="Aadhar" onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                    <i class="text-primary-bs fa-solid fa-id-card fs-5"></i>
                                    ${
                                      (item.proof_status == 'approved' || item.proof_status == 'approval_pending') 
                                      ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Preview" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">' 
                                      : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Preview" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                                    ${
                                      (item.proof_status == 'approved' || item.proof_status == 'approval_pending') 
                                        ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Approved" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                        : item.proof_status === 'Inreview'
                                        ? '<i class="fa-solid fa-hourglass-half me-2 text-warning doc-verified" style="max-height:80vh;"></i>'
                                        : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Rejected" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                                    <div class="text-primary-bs small">Aadhar</div>
                                  </div>
                                  <div class="action-icon text-center position-relative" title="Selfie" onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                    <i class="text-success-bs fa-solid fa-camera fs-5"></i>
                                    ${
                                      (item.selfie_status == 'approved' || item.selfie_status == 'approval_pending') 
                                        ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Approved" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                        : item.selfie_status === 'Inreview'
                                        ? '<i class="fa-solid fa-hourglass-half me-2 text-warning doc-verified" style="max-height:80vh;"></i>'
                                        : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Rejected" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                                    <div class="small text-success-bs">Selfie</div>
                                  </div>
                                  <div class="action-icon text-center position-relative ${item.type == 'Owner' ? 'd-none' : ''}" title="Driving Licence " onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                    <i class="text-warning-bs fa-solid fa-id-badge fs-5"></i>
                                    ${
                                      (item.dl_status == 'approved' || item.dl_status == 'approval_pending') 
                                        ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Approved" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                        : item.dl_status === 'Inreview'
                                        ? '<i class="fa-solid fa-hourglass-half me-2 text-warning doc-verified" style="max-height:80vh;"></i>'
                                        : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Rejected" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                                    <div class="small text-warning-bs">DL</div>
                                  </div>
                                  <div class="action-icon text-center position-relative ${item.type == 'Owner' ? 'd-none' : ''}" title="Vehicles" onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                    <i class="text-danger-bs fa-solid fa-car fs-5"></i>
                                    ${
                                      (item.vehicle_verify == '2') 
                                        ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Approved" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                        : item.dl_status === '1'
                                        ? '<i class="fa-solid fa-hourglass-half me-2 text-warning doc-verified" style="max-height:80vh;"></i>'
                                        : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Rejected" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                  ...
                                  <div class="action-icon text-center position-relative ${item.type == 'Owner' ? '' : 'd-none'}" title="Name Board" onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                    <i class="text-success-bs fa-solid fa-sign-hanging fs-5"></i>
                                    ${
                                      (item.o_proof_status == 'approved' || item.o_proof_status == 'approval_pending') 
                                        ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Approved" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                        : item.o_proof_status === 'Inreview'
                                        ? '<i class="fa-solid fa-hourglass-half me-2 text-warning doc-verified" style="max-height:80vh;"></i>'
                                        : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Rejected" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                               ...
                               <div class="mt-3 justify-content-around border-top pt-3 d-flex">
                                  <div class="action-icon text-center position-relative" title="User Verify">
                                    <button class="btn btn-primary px-4"
                                      onclick="localStorage.setItem('activeTab', 'USER'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                      <i class="fa-solid fa-user-check me-2"></i> User Verify
                                    </button>
                                    ${
                                      item.doc_verify == '1'
                                      ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Verified" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                      : '<img src="https://cdn-icons-png.flaticon.com/64/10015/10015336.png" alt="Not Verified" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
                                    }
                                  </div>
                                  <div class="action-icon text-center position-relative ${item.type == 'Owner' ? 'd-none' : ''}" title="Vehicle Verify">
                                    <button class="btn btn-success px-4"
                                      onclick="localStorage.setItem('activeTab', 'VEHICLE'); window.open('/kyc-verify/verify/${item.user_id}/${item.id}', '_blank');">
                                      <i class="fa-solid fa-car-side me-2"></i> Vehicle Verify
                                    </button>
                                    ${
                                      item.vehicle_verify == '2'
                                      ? '<img src="https://cdn-icons-png.flaticon.com/64/18295/18295118.png" alt="Verified" class="img-fluid doc-verified" style="max-height:80vh; object-fit:contain;">'
    ...
    // function redirectToVerify(u_id, id, type) {
    //   const userId = u_id || null;
    //   const recordID = id || null;
    //   if (!userId || !recordID) {
    //     toast('error', 'Invalid Type or Record Id not found');
    //     return;
    //   }
    // //   if (type === "USER") {
    // //     localStorage.setItem("kycData", JSON.stringify(item));
    // //   } else if (type === "VEHICLE") {
    // //     localStorage.setItem("vehicleData", JSON.stringify(item));
    // //   }
    // //   let url = "";
    // //   if (type === "USER") {
    // //     // url = `https://console.goride.run/kyc-verify/verify/${encodeURIComponent(userId)}/${encodeURIComponent(recordID)}/USERVERIFY`;
    // //     localStorage.setItem("activeTab", type);
    // //   } else if (type === "VEHICLE") {
    // //     // url = `https://console.goride.run/vehicle-verify/verify/${encodeURIComponent(userId)}/${encodeURIComponent(recordID)}/VEHICLEVERIFY`;
    // //   }
    //     localStorage.setItem("activeTab", type);
    //   // Redirect
    //   window.location.href = `/kyc-verify/${userId}/${recordID}`;
    // }
                    ...
                    if (response.type == 1) {
                        if (txt == 'DRIVING_LICENSE') {
                            ...
                            if (details) {
                                ...
                                let isVerify = false;
                                if (data.status && (data.dl_status == 'approved' || data.dl_status ==
                                        'Verified')) {
                                    isVerify = true;
                            ...
                            if (data.o_proof_type == 'name_board') {
                                ...
                                `;
                                let isVerify = false;
                                if (data.o_proof_status && (data.o_proof_status == 'approved' || data
                                        .o_proof_status == 'Verified')) {
                                    isVerify = true;
                                    $('#confirmBlockModal .modal-title').html(
                                        'Kyc Details <span class="badge bg-success">Verified</span>');
                                } else {
                                ...
                                $('#confirmBlockModal .modal-body').html(html);
                                $('#confirmBlockModal').modal('show');
                            } else if (data.o_proof_type == 'gst' && (data.gst_details == null || data
                                    .gst_details == '')) {
                                let html = `
                                ...
                                $('#confirmBlockModal .modal-body').html(html);
                                $('#confirmBlockModal .modal-title').html(
                                    'Search'); // optional, change modal title
                                $('#confirmBlockModal').modal('show');
                                ...
                                `;
                                    ...
                                    let isVerify = false;
                                    if (data.status && (data.o_proof_status == 'approved' || data
                                            .o_proof_status == 'Verified')) {
                                        isVerify = true;
                                        $('#confirmBlockModal .modal-title').html(
                                            'Kyc Details <span class="badge bg-success">Verified</span>');
                            ...
                            `;
                            let isVerify = false;
                            if (data.proof_status && (data.proof_status == 'approved' || data.proof_status ==
                                    'Verified')) {
                                isVerify = true;
                                $('#confirmBlockModal .modal-title').html(
                                    'Kyc Details <span class="badge bg-success">Verified</span>');
                            ...
                            if (data.proof_type != 'AADHAR_DIGILOCKER') {
                                ...
                                // $('#confirmBlockModal').modal('show');
                                $('#confirmBlockModal .modal-body').html(html);
                                $('#confirmBlockModal .modal-dialog').removeClass('modal-lg modal-xl modal-sm');
                                // if (data.proof_type == 'Aadhar') {
                                // }
                                $('#confirmBlockModal .modal-dialog').addClass('modal-lg');
                                $('#confirmBlockModal').modal('show');
                            } else {
                                html += `
                                    <div class="row mb-2 d-flex gap-3">
    ...
    $(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (response.type == 1) {
                        ...
                        slider.css('background-color', !isChecked ? '#49117cc9' : '#ccc');
                        innerKnob.css('transform', !isChecked ? 'translateX(22px)' :
                            'translateX(0)');
                    }
                },
                error: function() {
        ...
        try {
            ...
            $('#datefilterLogin').trigger('cancel.daterangepicker');
            var isPending = getCookie("isPending");
            var isVehicle = getCookie("isVehicle");
            var isNoComplete = getCookie("isNotComp");
            if (isPending == "true") {
                ...
                $("#kyc_filter").prop("selectedIndex", 2).trigger("change");
            }
            if (isNoComplete == "true") {
                const start = moment().startOf('year');
                const end = moment().endOf('year');
                $("#datefilterLogin").data('daterangepicker').setStartDate(start);
                $("#datefilterLogin").data('daterangepicker').setEndDate(end);
                ...
                $("#kyc_filter").prop("selectedIndex", 1).trigger("change");
            }
            if (isVehicle == "true") {
                const start = moment().startOf('year');
                const end = moment().endOf('year');
                ...
                $("#kyc_filter").prop("selectedIndex", 6).trigger("change");
            }
            unsubscribeList();
            setCookie('isPending', '');
            setCookie('isVehicle', '');
...
// Function to open the modal and fetch existing remarks
function openRemarksModal(user_id, user_name, mem_id) { // <-- Add mem_id parameter
    $('#rmk_user_id').val(user_id);
    $('#rmk_mem_id').val(mem_id); // <-- Store mem_id in hidden input
...
function fetchRemarks(user_id) {
    $.ajax({
        url: origin + "/ajax/service/datatable_services.php", // Update this to your PHP file path if different
        method: "POST",
        dataType: "json",
        data: {
        ...
        success: function(response) {
            let tbody = '';
            if (response.type == 1 && response.data.length > 0) {
...
// Function to save a new remark without closing the modal
function saveRemark() {
