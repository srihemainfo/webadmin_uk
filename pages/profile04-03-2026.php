                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-select" id="cab_types" name="cab_type" required title="Please select vehicle type">
                                        ...
                                        <option value="Go 4Seater" <?= ($cabType === 'Go 4Seater' || $cabType === 'Go 4Seater') ? 'selected' : '' ?>>Go 4Seater</option>
                                        <option value="Go 6Seater" <?= ($cabType === 'Go 6Seater') ? 'selected' : '' ?>>Go 6Seater</option>
                                        <option value="7Seater" <?= ($cabType === '7Seater') ? 'selected' : '' ?>>Go 7Seater</option>
                                    </select>
                                </div>
                            </div>
...
function validateForm() {
    ...
    const fields = [
        ...
        { name: 'puc_upto', required: true, pattern: /^\d{4}-\d{2}-\d{2}$/, message: 'PUC Expiry date is required.' },
        ...
        { name: 'reviews', required: false, pattern: /.*/ },
        { name: 'remarks', required: false, pattern: /.*/ },
        { name: 'agent_id', required: false, pattern: /.*/ },
        { name: 'maker_model', required: false, pattern: /.*/ },
        { name: 'car_colour', required: false, pattern: /.*/ }
    ];
