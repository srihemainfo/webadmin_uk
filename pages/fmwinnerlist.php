                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <h3 class="card-title"><?= ucwords('Winner Announcement'); ?></h3>
                                </div>
                                <div class="col-lg-4  col-sm-10 ">
                                    <span>Select Contest Date</span> &nbsp; <span style="color:red;">*</span>
                                    <div id="reportrangeAnnounce" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc; width: 100%">
                                        <i class="fa fa-calendar"></i>&nbsp;
                                        <span></span> <i class="fa fa-caret-down"></i>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-sm-2 mt-5">
                                    <a class="btn text-primary btn-sm" onclick="editForm()"><span class="fa fa-trophy fs-14">&nbsp;Announce</span></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-12">
                                    <h3 class="card-title"><?= ucwords('Winner List'); ?></h3>
                                </div>
                                <div class="col-lg-4  col-sm-10 ">
                                    <span>Select Contest Date</span> &nbsp; <span style="color:red;">*</span>
                                ...
                                <table class="table table-bordered text-nowrap border-bottom dataTable" id="emailLog" style="width:100%;">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-15p border-bottom-0">Prize Amount</th>
...
<script>
    $(function() {
        createDatePricketAnnounce('reportrangeAnnounce');
    ...
    function editForm() {
        try {
            ...
            formdata.push({
                ...
                name: 'winnerlistData',
                value: moment($('#reportrangeAnnounce').data('daterangepicker').startDate._d).format("YYYY-MM-DD")
            });
            ...
            var onsuccess = function(data) {
                ...
                if (response != "") {
                    if (response.type == '1') {
                        ...
                        $(`#SaveBtn`).html(`<button class="btn btn-info" onclick="announceFMWinner(${response.winnerData.id})">Announce Winner</button>`);
                        $('#testmail').modal('show');
                    } else {
    ...
    function createDatePricketAnnounce(id) {
    ...
    function fmContestList() {
        ...
        // Add error handling for the AJAX call
        // table.ajax.fail(function(jqXHR, textStatus, errorThrown) {
