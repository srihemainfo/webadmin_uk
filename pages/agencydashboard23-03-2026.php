...
<script>
    /* =====================================================
   AUTO-SCHEDULE: FETCH LAST 5 JOBS & GENERATE DATES
===================================================== */

    /* =====================================================
       AUTO-SCHEDULE LOGIC (FROM schedule_dates TABLE)
    ===================================================== */

    /* =====================================================
       RE-SCHEDULE LOGIC (FROM schedule_dates TABLE)
    ===================================================== */
    ...
    /* =====================================================
       SAFE UI REFRESH HELPER (Prevents ReferenceError Crash)
    ===================================================== */
    ...
    // 3. HANDLE CLICKING A DRIVER FROM THE LIST
    $(document).on('click', '.map-driver-item', function(e) {
        ...
        // Fetch precise location using LARAVEL ROUTE
        $.ajax({
            ...
            success: function(res) {
                if (res.status && res.data) {
                    ...
                    // Safe check for driversMap global variable
                    if (lat && lng && typeof driversMap !== 'undefined' && driversMap && typeof driversMap.invalidateSize === 'function') {

                        // Force Leaflet to update its internal size container before flying
                        ...
                        `).openPopup();
                        }, 300); // 300ms delay guarantees the map UI is ready for coordinates
                    }
                } else {
...
===================================================== */
        ...
        function normalizeJob(job, source) {
            ...
            return {
                ...
                // ✅ FIXED MOBILE (Extracts from JSON if user_id is 0)
