...
<div class="offcanvas offcanvas-end" tabindex="-1" id="driverEditDrawer">
    <div class="offcanvas-header border-bottom d-flex justify-content-between p-3 bg-white">
        ...
        <div class="d-flex align-items-center gap-2">
            <button class="btn btn-light" type="button" id="closeDrawerBtn" title="Close" style="margin-right: 168px;">
                <i class="fa fa-times"></i>
            </button>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-2"> <div class="d-flex justify-content-between align-items-center mb-2 border-bottom pb-1">
    ...
    <div class="view-mode" id="view-driver-profile">
                ...
                <div class="d-flex justify-content-between align-items-center mb-1">
                    ...
                    <div class="d-flex gap-2 flex-shrink-0">
                        <a href="tel:9876543210" class="call-icon text-decoration-none" title="Call">
                            <i class="fa fa-phone text-primary bg-light rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; font-size: 12px;"></i>
                        </a>
                        <a href="https://wa.me/919876543210" class="whatsapp-icon text-decoration-none" title="WhatsApp">
                            <i class="fab fa-whatsapp text-success bg-light rounded-circle shadow-sm d-flex align-items-center justify-content-center" style="width: 24px; height: 24px; font-size: 14px;"></i>
                        </a>
                    </div>
                </div>
        ...
        <div class="row g-1" style="font-size: 12px;">
            <div class="col-12 text-truncate" title="Address">
                <i class="fa fa-address-card text-dark me-1 text-center" style="width: 14px;"></i>
    ...
    <div class="edit-mode" id="edit-driver-profile" style="display: none;">
        <div class="row g-1 small">
            ...
            <div class="col-6">
                ...
                <select class="form-control form-select form-select-sm py-1" id="edit_state" data-field="state" title="Select state">
                    <option value="">Select State</option>
                    <?php
                    $query = mysqli_query($con, "SELECT id, name FROM states WHERE country_code = 'IN'");
                    while ($rows = mysqli_fetch_assoc($query)) {
                        $selected = ($rows['name'] == $driverState) ? 'selected' : '';
            ...
            <div class="col-6">
                <label class="form-label fw-semibold mb-0" style="font-size: 11px;">City</label>
                <input type="text" class="form-control form-control-sm edit-field py-1" id="edit_city" data-field="city" value="Chennai">
            </div>
            <div class="col-12">
                <label class="form-label fw-semibold mb-0" style="font-size: 11px;">Address</label>
                <input type="text" class="form-control form-control-sm edit-field py-1" id="edit_address" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g,'').slice(0,150)" data-field="address" value="123, Anna Salai, T. Nagar, Chennai - 600017">
            </div>
                                ...
                                <div class="view-mode" id="view-vehicle">
                                    ...
                                    <div class="d-flex flex-wrap gap-3 mb-2 ">
                                        ...
                                        <div>
                                            ...
                                            <span id="display_luggage">3</span>
                                        </div>
                                    </div>
                                    <!-- Row 3 -->
...
<div class="offcanvas offcanvas-end" tabindex="1" id="driverPreviewCanvas">
    ...
    <div class="offcanvas-body p-0">
            ...
            <div class="card-body p-3 position-relative">
                ...
                <div class="d-flex align-items-center mt-3">
                    <img src="/assets/images/driver.png" alt="Driver Photo" id="preview_driver_photo"
                        class="rounded-circle me-3 cursor-pointer border"
                        style="width:60px;height:60px;object-fit:cover;"
                        data-bs-toggle="modal" data-bs-target="#driverPhotoModal">
                    <div class="w-100">
                        <div class="d-flex justify-content-between align-items-center">
        ...
        <button type="button" class="btn btn-info btn-sm" onclick="loadEditLogs()" style="margin-left: -13px;">
            <i class="fa fa-history"></i>
                ...
                <hr class="my-3">
                <strong><i class="fa fa-car me-1 text-danger"></i> Vehicle Details</strong>
                <div class="d-flex align-items-center mt-3">
                    <img src="/assets/images/carimage.png" alt="Car Image" id="preview_vehicle_photo"
                        class="rounded me-3 cursor-pointer border"
                    ...
                    <div class="w-100">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="font-size:13px">
                                ...
                                <span><i class="fa fa-check-circle text-success me-1"></i></span>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    if (!window.editLanguagesTomSelect) {
        window.editLanguagesTomSelect = new TomSelect("#edit_languages", {
            plugins: ['remove_button'], // adds small "x" to remove selections
...
`;
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if (d.mobile) {
                const cleanMobile = String(d.mobile).replace(/\D/g, '');
                $('#preview_driver_no').text(`(${cleanMobile})`);
            ...
            $('#preview_license').html(`<i class="fa fa-id-badge text-primary me-1"></i> <strong>${d.dl_no || 'N/A'}</strong> | <strong>${dlExpiryStr}</strong>`);

            // --- 2. Vehicle Parsing ---
            let vName = 'N/A', vModel = 'N/A', vFuel = 'N/A', vSeats = 'N/A', vLuggage = 'N/A';
            let rcExpiry = 'N/A', inExpiry = 'N/A', vImage = '/assets/images/carimage.png';
            let languages = 'N/A';
            ...
            if (d.vehicle_details) {
                try {
                    ...
                    vFuel = vehicleData.vehicle_questions?.fuel_type || d.vehicle_type || 'N/A';
                    ...
                    if (images.length === 0) {
                        ...
                        images.forEach((img, index) => {
                            carouselInner.append(`<div class="carousel-item ${index === 0 ? 'active' : ''}"><img src="${img}" class="img-fluid" style="max-height:250px;"></div>`);
                        });
                    }
                } catch (e) {
        ...
        function openDriverEditDrawer(id) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    // ✅ ADD THESE LINES TO UPDATE LUGGAGE IN THE CENTER PANEL
...
<script>
    ...
    let driverId = $('#preview_driver_id').val();
    if (!driverId) {
