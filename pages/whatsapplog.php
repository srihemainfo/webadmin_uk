        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                ...
                <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left"
                            onclick="history.go(-1)" aria-hidden="true"></i></a>WhatsApp Report</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-sm-6 mb-2">
                                                <span>Select WhatsApp Gateway</span>
                                                <select id="gatewayname" onchange="changestatus($(this).val())"
                                                    class="form-select">
                                                    <?php
                                                    $selectQuery = mysqli_query($con, "SELECT gateway FROM `smslog` GROUP BY `gateway`");
                                                    if (mysqli_num_rows($selectQuery) > 0) {
                                                        while ($row = mysqli_fetch_assoc($selectQuery)) {
                                                    ?>
                                                    <option value="<?= $row['gateway']; ?>">
                                                        <?= ucfirst(strtolower($row['gateway'])); ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
...
function setCCookie(name, value, days = 1) {
    let expires = "";
    if (days) {
        const date = new Date();
