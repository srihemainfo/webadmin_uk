                    ...
                    <div class="row align-items-start">
                        ...
                        <div class="col-lg-5 mb-4">
                            ...
                            <div class="radio-group-container">
                                ...
                                <label class="custom-radio-label"><input type="radio" name="target_user" value="specific_mobiles" > Specific Users</label>
                        ...
                        <!-- NEW: Specific Mobiles Input Container -->
...
<!-- Modal for Viewing Detailed Push Report -->
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content" style="border: 1px solid #bbb;">
            <div class="modal-header p-4 d-flex align-items-center" style="border-bottom: 1px solid #eee;">
                ...
                <!-- FIXED CLOSE BUTTON (Using jQuery onclick to bypass Bootstrap bugs) -->
...
<script>
    ...
    function sendPushNotification() {
        ...
        if (target === 'specific_mobiles') {
            ...
            triggerAjaxSubmit("/admin-send-specific-push", formData);
        } 
        else {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.status) {
                    ...
                    $('#push_title').val(''); $('#push_body').val(''); $('#push_image').val(''); $('#specific_mobiles_input').val('');
    ...
    function copyMobileNumbers() {
        ...
        // Try the modern Navigator API first (requires HTTPS)
    ...
    function executeFallbackCopy(text, count) {
        ...
        textArea.style.opacity = "0"; // Make it completely invisible
    ...
    $('#resendFromModalBtn').on('click', function() {
        ...
        $('.modal-user-table .user-checkbox:checked').each(function() {
            var val = $(this).val(); // FIXED: Removed parseInt() to support prefixed IDs like "driver-5"
