                        ...
                        <div class="card-body d-flex justify-content-between align-items-center">
                          ...
                          <div>
                           ...
                           <div class="d-flex gap-4 text-muted">
                                    ...
                                    <!-- <div>-->
                                        <!--Not Verified-->
                                        <!--<span id="sts_notverifi" class="fw-bold text-dark">0</span>-->
                                    <!--</div>-->
                                </div>
                 ...
                 <div class="col-6 mt-3">
                    <div class="card shadow-sm border-start border-4 border-primary">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <!-- Content -->
                        <div class="row text-center">
                                 <div class="d-flex text-muted gap-4" id="seatCountContainer">
                                        <!-- <span id = "value_count"></span> -->
                                    </div>
...
<!--                        <input type="text" id="reg_company" class="form-control" placeholder="Enter Company Name">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
...
<!--                        <input type="tel" id="reg_mobile" class="form-control" placeholder="Enter Mobile">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
<!--                        <label class="form-label">Email</label>-->
<!--                        <input type="email" id="reg_email" class="form-control" placeholder="Enter Email">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
...
<!--                        </select>-->
<!--                    </div>-->
<!--                    <button type="button" class="btn btn-primary w-100" id="btnSendOTP">Register & Send OTP</button>-->
<!--                </div>-->

<!--                <div id="otpSection" style="display: none;" class="mt-4 border-top pt-3">-->
<!--                    <label class="form-label">Enter OTP</label>-->
<!--                    <div class="input-group">-->
<!--                        <input type="text" id="otp_code" class="form-control" placeholder="6-digit code">-->
<!--                        <button class="btn btn-success" type="button" id="btnVerifyOTP">Verify OTP</button>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
...
<!--                <h5 class="modal-title fw-semibold text-secondary">Register User</h5>-->
...
<!--                        <input type="text" id="reg_company" class="form-control py-2" placeholder="Enter Company Name">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
<!--                        <label class="form-label small fw-bold text-muted">Name</label>-->
<!--                        <input type="text" id="reg_name" class="form-control py-2" placeholder="Enter Name">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
<!--                        <label class="form-label small fw-bold text-muted">Mobile</label>-->
<!--                        <input type="tel" id="reg_mobile" class="form-control py-2" placeholder="Enter Mobile">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
<!--                        <label class="form-label small fw-bold text-muted">Email</label>-->
<!--                        <input type="email" id="reg_email" class="form-control py-2" placeholder="Enter Email">-->
<!--                    </div>-->
<!--                    <div class="mb-3">-->
<!--                        <label class="form-label small fw-bold text-muted">Role Type</label>-->
<!--                        <select id="reg_role" class="form-select py-2">-->
<!--                            <option value="Owner">Owner</option>-->
<!--                            <option value="Driver">Driver</option>-->
<!--                        </select>-->
<!--                    </div>-->
<!--                    <button type="button" class="btn btn-primary w-100 py-2 fw-bold" id="btnSendOTP" style="background-color: #7d8da1; border: none;">-->
<!--                        Register & Send OTP-->
<!--                    </button>-->
<!--                </div>-->
...
<!--                <button type="button" class="btn btn-info text-white px-4 py-2 fw-bold" data-bs-dismiss="modal" style="border-radius: 8px;">-->
<!--                    Cancel-->
<!--                </button>-->
<!--            </div>-->
<!--        </div>-->
