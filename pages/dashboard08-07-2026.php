...
<div class="main-content app-content mt-0">
                            ...
                            <div class="card shadow-sm border-start border-4 h-100" style="border-color: #20c997;">
                                <div class="card-body p-3">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#unassigned'">
                                            Unassigned:<span id="jd_unassigned" class="job-stat-val text-primary fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#assigned'">
                                            Assigned:<span id="jd_assigned" class="job-stat-val text-success fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#completed'">
                                            Completed:<span id="jd_completed" class="job-stat-val text-info fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#websiteBookings'">
                                            Website:<span id="jd_website" class="job-stat-val text-warning fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#cancelledJobs'">
                                            Cancelled:<span id="jd_cancelled" class="job-stat-val text-danger fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#expiredJobs'">
        ...
        <div class="card-body">
            <div style="width: 100%;">
                ...
                <div class="d-flex justify-content-between align-items-center mb-1">
                    <h6 class="fw-bold mb-0" style="color: #f59e0b;">KYC Pending</h6>
                    
                    <div id="kyc_pending_daterange"
                        style="cursor:pointer; background: #fff; border: 1px solid #e0e0e0; padding: 3px 8px; border-radius: 4px; font-size: 11px; color: #555; white-space: nowrap;"
                        onclick="event.stopPropagation();">
                        <i class="bi bi-calendar3"></i>&nbsp;
                        <span>This Year</span>&nbsp;
                        <i class="bi bi-caret-down-fill" style="font-size: 10px;"></i>
                ...
                <a href="kyc-details/"
                    ...
                    target="_blank" style="font-size: 25px; text-decoration: none;">0</a>

                <!-- FIX: Kept flex-nowrap to keep them in one row, added mt-3 for spacing -->
                <div class="d-flex flex-nowrap justify-content-between text-muted mt-3">
                    
                    <!-- FIX: Stacked vertically using flex-column, centered, and increased font size -->
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">Sel</span>
                        <span id="count_selfie" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">Aadhar</span>
                        <span id="count_aadhar" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">DL</span>
                        <span id="count_dl" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">Vehicle</span>
                        <span id="vehicle_p_count" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">GST</span>
                        <span id="count_gst" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    
                    <div class="d-flex flex-column align-items-center text-nowrap">
                        <span style="font-size: 13px;">Board</span>
                        <span id="count_name_board" class="fw-bold text-dark mt-1" style="font-size: 16px;">0</span>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mt-3">
                            <div class="card shadow-sm border-start border-4 border-primary" onclick="window.location.href='https://console.goride.run/cab-types/'" style="cursor: pointer;">
                                <div class="card-body">
                                    <div>
                                    ...
                                    <div class="row text-center">
                                        <div class="d-flex text-muted gap-4 fw-bold flex-wrap" id="cabCountContainer">
                ...
                <div class="tab-pane fade" id="customer-pane" role="tabpanel" aria-labelledby="customer-tab">
                    <div class="row g-3">
                        <div class="col-md-6 col-lg-4">
                            <div class="card shadow-sm border-start border-4 h-80" style="border-color: #20c997;">
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <h6 class="fw-bold mb-0 cursor-pointer" style="color: #20c997; font-size: 15px;" onclick="window.location.href='https://console.goride.run/agencydashboard/'">
                                            <i class="bi bi-briefcase-fill me-1"></i> Job Details
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#completed'">
                                            Completed:<span id="jd_completed_cus" class="job-stat-val text-info fw-bold ms-1">0</span>
                                        </div>
                                        <div class="job-stat-item job-stat-link" style="width: 31%;" onclick="window.location.href='https://console.goride.run/agencydashboard/#websiteBookings'">
    ...
    <div class="card shadow-sm border-start border-4" style="border-color: #6f42c1;">
        <div class="card-body p-2 d-flex flex-column"> 
            
            <!-- Header Section -->
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="fw-bold mb-0 cursor-pointer text-truncate me-1" style="color: #6f42c1; font-size: 14px;" onclick="window.location.href='/car-pool/kyc'">
                    Carpool KYC
                </h6>
                <div class="d-flex align-items-center gap-1">
                    <div id="carpool_kyc_daterange"
                        class="d-flex align-items-center shadow-sm"
                        style="cursor:pointer; background: #fff; border: 1px solid #ced4da; padding: 2px 8px; border-radius: 4px; font-size: 12px; color: #444; white-space: nowrap;"
                        onclick="event.stopPropagation();">
            ...
            <!-- Horizontal 3-Column Layout (Selfie, DL, RC) -->
            <div class="row g-2 text-center cursor-pointer" onclick="window.location.href='/car-pool/kyc'">
                
                <!-- 1. Selfie Block -->
                <div class="col-4">
                    <div class="bg-light border p-2 d-flex flex-column shadow-sm" style="border-radius: 4px;">
                        <div class="text-muted fw-bold text-uppercase text-truncate mb-1" style="font-size: 11px; letter-spacing: 0.5px;">Selfie Received</div>
                        <div id="c_selfie_tot" class="text-dark fw-bolder mb-2" style="font-size: 24px; line-height: 1;">0</div>
                        
                        <div class="d-flex justify-content-between align-items-center border-top pt-2 mt-1">
                            <div class="w-100 text-success" title="Verified">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">V</div>
                                <div id="c_selfie_v" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-warning border-start border-end" title="Pending">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">P</div>
                                <div id="c_selfie_p" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-danger" title="Rejected">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">R</div>
                                <div id="c_selfie_r" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="bg-light border p-2 d-flex flex-column shadow-sm" style="border-radius: 4px;">
                        <div class="text-muted fw-bold text-uppercase text-truncate mb-1" style="font-size: 11px; letter-spacing: 0.5px;">DL Received</div>
                        <div id="c_dl_tot" class="text-dark fw-bolder mb-2" style="font-size: 24px; line-height: 1;">0</div>
                        
                        <div class="d-flex justify-content-between align-items-center border-top pt-2 mt-1">
                            <div class="w-100 text-success" title="Verified">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">V</div>
                                <div id="c_dl_v" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-warning border-start border-end" title="Pending">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">P</div>
                                <div id="c_dl_p" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-danger" title="Rejected">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">R</div>
                                <div id="c_dl_r" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="bg-light border p-2 d-flex flex-column shadow-sm" style="border-radius: 4px;">
                        <div class="text-muted fw-bold text-uppercase text-truncate mb-1" style="font-size: 11px; letter-spacing: 0.5px;">RC Received</div>
                        <div id="c_rc_tot" class="text-dark fw-bolder mb-2" style="font-size: 24px; line-height: 1;">0</div>
                        
                        <div class="d-flex justify-content-between align-items-center border-top pt-2 mt-1">
                            <div class="w-100 text-success" title="Verified">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">V</div>
                                <div id="c_rc_v" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-warning border-start border-end" title="Pending">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">P</div>
                                <div id="c_rc_p" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                            <div class="w-100 text-danger" title="Rejected">
                                <div style="font-size: 10px; color: #888; font-weight:bold; margin-bottom: 2px;">R</div>
                                <div id="c_rc_r" style="font-size: 14px; font-weight: 800;">0</div>
                            </div>
                        </div>
                    </div>
                </div>
                      ...
                      <div class="col-md-6 col-lg-4">
    <div class="card shadow-sm border-start border-4 border-danger" style="cursor: pointer; transition: all 0.3s ease;"
         onmouseover="this.style.transform='translateY(-3px)'; this.style.boxShadow='0 10px 20px rgba(0,0,0,0.1)';"
         onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='';"
         onclick="window.location.href = window.location.origin + '/job-wallet-history/'">
        <div class="card-body d-flex justify-content-between align-items-center">
            <div class="w-100">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="fw-bold mb-0" style="color:#d9462c;">Pending Payments</h6>
                </div>
                
                <div class="d-flex align-items-center mb-2">
                    <span class="text-muted fw-semibold me-2" style="font-size: 14px;">Total Count :- </span>
                    <span id="pending_pay_count" class="text-dark" style="font-size: 26px; font-weight: 900; line-height: 1;">0</span>
                </div>
                
                <div class="d-flex align-items-center">
                    <span class="text-muted fw-semibold me-2" style="font-size: 14px;">Total Amount :- </span>
                    <span id="pending_pay_total_amount" class="text-danger" style="font-size: 20px; font-weight: 800; line-height: 1;">₹ 0.00</span>
                </div>
            </div>
            
            <i class="bi bi-hourglass-split ms-2" style="font-size: 2.5rem; color:#d9462c; opacity: 0.2;"></i>
        </div>
    </div>
</div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-12 mb-2">
                                            <span>Select Pickup Date</span><span style="color:red;">*</span>
                                            <input class="form-control" type="text" id="datefilterCustomerBookings" value="" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="chart-container" style="position: relative; height: 200px;">
                                        <canvas id="customerBookingsChart"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-12 d-flex align-items-center justify-content-between">
                                            <h4 class="card-title">Carpool Bookings</h4>
                                        </div>
                                        <div class="col-12 mb-2">
                                            <span>Select Pickup Date</span><span style="color:red;">*</span>
                                            <input class="form-control" type="text" id="datefilterCarpoolBookings" value="" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="chart-container" style="position: relative; height: 200px;">
                                        <canvas id="carpoolBookingsChart"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php else: ?>
    <script>
        ...
        var url1 = "http://smsresell.cwd.co.in/api/checkbalance.php?user=senthil123&pass=srihema567";
        const tapAndWinFlow = () => {
            try {
                $.ajax({
                    url: url,
                ...
                success: function(res) {
                    if (res.type == '1') {
                        ...
                        <div class="text-center">
                            <span class="fw-bold text-dark">${item.cab_name}</span><br>
                            <span class="fw-bold text-dark">${item.user_count}</span>
                        </div>
                    `;
                        });
                        $('#cabCountContainer').html(html);
                    } else {
                        $('#cabCountContainer').html('<span class="text-danger small">No data found</span>');
                    }
                },
                error: function(xhr, status, error) {
                    console.error("Error fetching cab counts:", error);
                    $('#cabCountContainer').html('<span class="text-danger small">Error loading</span>');
                }
            });
        };
        const seatCounts = () => {
        ...
        // 1. Updated AJAX Function
const uPendingCounts = (startDate, endDate) => {
    $.ajax({
        url: url,
        type: "POST",
        data: {
        ...
        success: function(res) {
            if (res.type == '1') {
                const counts = {};
                res.result.forEach(item => {
                    counts[item.type] = item.total || 0;
                });

                $("#kyc_p_count").text(counts['kyc_count'] || 0);
                $("#count_dl").text(counts['dl_pending_count'] || 0);
                $("#count_aadhar").text(counts['aadhar_pending_count'] || 0);
                $("#count_selfie").text(counts['selfie_pending_count'] || 0);
                $("#count_pan").text(counts['pan_pending_count'] || 0);
                $("#count_gst").text(counts['gst_pending_count'] || 0);
                $("#count_name_board").text(counts['name_board_pending_count'] || 0);

                $("#vehicle_p_count").text(counts['vehicle_count'] || 0);
                $("#error_logs_count").text(counts['error_log'] || 0);
                $("#expiry_count").text(counts['expiry_count'] || 0);
                $("#cancelled_count").text(counts['cancelled_count'] || 0);
                $("#not_complete_count").text(counts['n_complete_count'] || 0);
                $("#cons_count").text(counts['consent_count'] || 0);
                $("#sts_reject").text(counts['reject_count'] || 0);
                
                $("#v_driver").text(counts['v_driver'] || 0);
                $("#v_owner").text(counts['v_owner'] || 0);
                $("#d_both").text(counts['v_driver'] || 0); 
                $("#o_kyc").text(counts['v_owner'] || 0);   
                $("#d_kyc").text(counts['k_v_driver'] || 0);
                $("#d_veh").text(counts['v_v_driver'] || 0);
                
                $("#sms_count").text(counts['sms_count'] || 0);
                $("#l_web").text(counts['lead_web'] || 0);
                $("#post_web").text(counts['post_web'] || 0);
                $("#kyc_missing_count").text(counts['kyc_missing_count'] || 0);

                // const non_kyc_count = parseInt(counts['kyc_n_count'] || 0);
                // const non_kyc_count_wo_kyc = parseInt(counts['kyc_missing_count'] || 0);
                // $('#kyc_nc_count').text(non_kyc_count + non_kyc_count_wo_kyc);

                const shiCount = parseInt(counts['shi_count'] || 0);
                const whCount = parseInt(counts['wh_count'] || 0);
                $("#total_wh_count").text(shiCount + whCount);

            } else {
                $("#kyc_p_count, #count_dl, #count_aadhar, #count_selfie, #count_pan, #count_gst, #count_name_board").text(0);
                $("#vehicle_p_count, #error_logs_count, #expiry_count, #cancelled_count, #not_complete_count").text(0);
                $("#cons_count, #sts_reject, #v_driver, #v_owner, #d_both, #o_kyc, #d_kyc, #d_veh").text(0);
                $("#sms_count, #l_web, #post_web, #kyc_missing_count, #kyc_nc_count, #total_wh_count").text(0);
            }
        },
        error: function(xhr, status, error) {
            console.error("Error fetching pending counts:", error);
    ...
    $.ajax({
        ...
        dataType: "json",
        data: {
            method: 'pending_payment_dashboard_counts'
        },
        success: function(res) {
            if (res.type == 1) {
                ...
                $("#pending_pay_total_amount").text(formatAmt(res.total_amount));
                $("#pending_pay_count").text(res.total_count);
            }
        },
        error: function(xhr, status, error) {
        ...
        $(function() {
            ...
            $(`#datefilterDriverJobs`).on('apply.daterangepicker', function(ev, picker) {
                loadAppJobsChart('GRD');
            });
            $(`#datefilterCustomerJobs`).on('apply.daterangepicker', function(ev, picker) {
            ...
            initCarpoolKycDatePicker()
            initKYCPendingDatePicker();
            // collect_earning();
            // paymenttype();
            // createChart();
            ownerchart();
            ...
            <?php } ?>
            // 1. Declare the chart instance variable at the top with your others
            // 1. Declare the chart instance variable
            var carpoolBookingsChartInst;
            // 2. Set default range: 3 days in the past to 3 days in the future
            var carpoolStart = moment().subtract(3, 'days');
            var carpoolEnd = moment().add(3, 'days');
            // Initialize the standard Date Picker (No quick-select ranges)
            $('#datefilterCarpoolBookings').daterangepicker({
                startDate: carpoolStart,
                endDate: carpoolEnd,
                opens: 'left',
                locale: {
                    format: 'MM/DD/YYYY',
            ...
            // Set default value visually on page load
            $('#datefilterCarpoolBookings').val(carpoolStart.format('MM/DD/YYYY') + ' - ' + carpoolEnd.format('MM/DD/YYYY'));
            // Trigger chart update when a new date is applied
            $('#datefilterCarpoolBookings').on('apply.daterangepicker', function(ev, picker) {
                $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format('MM/DD/YYYY'));
                loadCarpoolBookingsChart();
            });
            // Clear input on cancel
            $('#datefilterCarpoolBookings').on('cancel.daterangepicker', function(ev, picker) {
                $(this).val('');
            });
            function initCarpoolKycDatePicker() {
            var start = moment();
            var end = moment();
            var rangesObj = {
                'Today': [moment(), moment()],
            ...
            function cbKyc(start, end) {
                var dateText = (start.format('YYYY-MM-DD') === end.format('YYYY-MM-DD')) ? start.format('MMM D') : start.format('MMM D') + ' - ' + end.format('MMM D');
                $('#carpool_kyc_daterange span').html(dateText);
                fetchCarpoolKycSummary(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'));
            }

            $('#carpool_kyc_daterange').daterangepicker({
                startDate: start,
                endDate: end,
                opens: 'left',
                ranges: rangesObj
        ...
        // 1. Create a global object to hold the data so we don't have to hit the DB every time the dropdown changes
let globalCarpoolKycData = {
...
// Fetch the data via AJAX and populate all three types
function fetchCarpoolKycSummary(startDate, endDate) {
    $.ajax({
        url: origin + "/ajax/service/dashBoard_Services.php",
        type: "POST",
        dataType: "json",
        data: {
            method: 'carpool_kyc_summary',
            start_date: startDate,
            end_date: endDate
        },
        success: function(res) {
            if (res.type == 1 && res.data) {
                ...
                // 1. Selfie Data
                $('#c_selfie_tot').text(res.data.selfie?.total || 0);
                $('#c_selfie_v').text(res.data.selfie?.verified || 0);
                $('#c_selfie_p').text(res.data.selfie?.pending || 0);
                $('#c_selfie_r').text(res.data.selfie?.rejected || 0);

                // 2. DL Data
                $('#c_dl_tot').text(res.data.dl?.total || 0);
                $('#c_dl_v').text(res.data.dl?.verified || 0);
                $('#c_dl_p').text(res.data.dl?.pending || 0);
                $('#c_dl_r').text(res.data.dl?.rejected || 0);

                // 3. RC (Vehicle) Data
                $('#c_rc_tot').text(res.data.vehicle?.total || 0);
                $('#c_rc_v').text(res.data.vehicle?.verified || 0);
                $('#c_rc_p').text(res.data.vehicle?.pending || 0);
                $('#c_rc_r').text(res.data.vehicle?.rejected || 0);
                
            }
        },
        error: function(xhr, status, error) {
            console.error("Error fetching Carpool KYC Summary:", error);
        }
    });
}

function renderKycWidget() {
    const selectedType = $('#kycDocTypeFilter').val(); // 'selfie', 'dl', or 'vehicle'
    const data = globalCarpoolKycData[selectedType];

    // Updated labels to be slightly more compact
    let label = "Selfie Received";
    if (selectedType === 'dl') label = "DL Received";
    if (selectedType === 'vehicle') label = "RC Received";

    $('#kycDynamicLabel').text(label);

    // Update the numbers
    $('#ckyc_dynamic_total').text(data.total || 0);
    $('#ckyc_dynamic_verified').text(data.verified || 0);
    $('#ckyc_dynamic_pending').text(data.pending || 0);
    $('#ckyc_dynamic_rejected').text(data.rejected || 0);
}

// 4. Listen for dropdown changes
$(document).ready(function() {
    $('#kycDocTypeFilter').on('change', function() {
        renderKycWidget();
    });
});
        
            // 3. Define the AJAX loader function
            const loadCarpoolBookingsChart = () => {
                try {
                    // Ensure we only run if a value is selected
                    var dateVal = $('#datefilterCarpoolBookings').val();
                    if (!dateVal) return false;
                    var startDate = moment($('#datefilterCarpoolBookings').data('daterangepicker').startDate).format("YYYY-MM-DD");
                    var endDate = moment($('#datefilterCarpoolBookings').data('daterangepicker').endDate).format("YYYY-MM-DD");
                    var formdata = [{
                            name: 'method',
                            value: "carpool_bookings_chart"
                        },
                        {
                            name: 'startDate',
                            value: startDate
                    ...
                    var onsuccess = function(data) {
                        try {
                            // FIXED: Only parse if 'data' is actually a string
                            var response = (typeof data === 'string') ? JSON.parse(data) : data;
                            if (response.type == 1) {
                                if (carpoolBookingsChartInst) carpoolBookingsChartInst.destroy();
                                var ctx = document.getElementById('carpoolBookingsChart').getContext('2d');
                                carpoolBookingsChartInst = new Chart(ctx, {
                                    type: 'bar',
                                    data: {
                                        labels: response.dates,
                                        datasets: [{
            ...
            // Initial load
            loadCarpoolBookingsChart();
            // 1. Add this near your other variable declarations at the top of the script
            var customerBookingsChartInst;
            // 2. Add the AJAX function
            const loadCustomerBookingsChart = () => {
                try {
                    var startDate = moment($('#datefilterCustomerBookings').data('daterangepicker').startDate).format("YYYY-MM-DD");
                    var endDate = moment($('#datefilterCustomerBookings').data('daterangepicker').endDate).format("YYYY-MM-DD");
                    if (!startDate || !endDate) return false;
                    var formdata = [{
                            name: 'method',
                            value: "customer_bookings_chart"
                        },
                        {
                            name: 'startDate',
                            value: startDate
                    ...
                    var onsuccess = function(data) {
                        try {
                            var response = JSON.parse(data);
                            if (response.type == 1) {
                                if (customerBookingsChartInst) customerBookingsChartInst.destroy();
                                var ctx = document.getElementById('customerBookingsChart').getContext('2d');
                                customerBookingsChartInst = new Chart(ctx, {
                                    type: 'bar',
                                    data: {
                                        labels: response.dates,
                                        datasets: [{
            ...
            // 3. Add this inside your $(function() { ... }) block to initialize the date picker and load the chart
            // 3. Initialize the date picker
            createDatePicker('datefilterCustomerBookings');
            var picker = $('#datefilterCustomerBookings').data('daterangepicker');
            if (picker) {
                // FIX: Override the maxDate restriction so future dates are allowed
                // Setting it to a far future date ensures it won't block your +3 days logic
                picker.maxDate = moment().add(10, 'years');
                // Calculate 3 days past and 3 days future
                var defaultStart = moment().subtract(3, 'days');
                var defaultEnd = moment().add(3, 'days');
                // Set the dates internally
                picker.setStartDate(defaultStart);
                picker.setEndDate(defaultEnd);
                // Update the input field visually (using MM/DD/YYYY to match your screenshot)
                $('#datefilterCustomerBookings').val(defaultStart.format('MM/DD/YYYY') + ' - ' + defaultEnd.format('MM/DD/YYYY'));
            }
            // Bind the event listener for when the user manually changes the date
            $('#datefilterCustomerBookings').on('apply.daterangepicker', function(ev, picker) {
                loadCustomerBookingsChart();
            });
            // Load default data on page load using the newly set -3 to +3 days range
            loadCustomerBookingsChart();
        ...
        function initJobDetailsDatePicker() {
            ...
            $('#job_summary_daterange').daterangepicker({
                startDate: start,
                endDate: end,
                opens: 'left',
                ranges: rangesObj
            ...
            $('#job_summary_daterange_cus').daterangepicker({
                startDate: start,
                endDate: end,
                opens: 'left',
                ranges: rangesObj
        ...
        function initKYCPendingDatePicker() {
    // 1. Set initial start and end to "This Year"
    var start = moment().startOf('year');
    var end = moment().endOf('year'); 
    
    // (Optional: If you only want from Jan 1st up to *today* instead of the end of the year, use: var end = moment();)
    ...
    var rangesObj = {
        ...
        'This Month': [moment().startOf('month'), moment().endOf('month')],
        'Last Month': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf('month')],
        // 2. Add 'This Year' to the dropdown menu
        'This Year': [moment().startOf('year'), moment().endOf('year')] 
    };

    function cbKyc(start, end) {
        // 3. Added the Year (YYYY) to the format so it looks better for yearly ranges
        var dateText = (start.format('YYYY-MM-DD') === end.format('YYYY-MM-DD')) 
            ? start.format('MMM D, YYYY') 
            : start.format('MMM D, YYYY') + ' - ' + end.format('MMM D, YYYY');
            
        $('#kyc_pending_daterange span').html(dateText);
        
        // Pass the selected dates to your existing function
        uPendingCounts(start.format('YYYY-MM-DD'), end.format('YYYY-MM-DD'));
    }

    $('#kyc_pending_daterange').daterangepicker({
        startDate: start,
        endDate: end,
        opens: 'left',
        ranges: rangesObj
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.type == 1) {
                        ...
                        $('#jd_completed' + suffix).text(res.data.completed_jobs); // Added Completed Binding
