 ...
 * */
$pageTitle = "Just3 Raffle Ticket Reports";
?>
<style>
    input,
    select {
...
<div class="main-content app-content mt-0">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item reportdwn" data-report="0" data-type="excel" href="#">Excel</a></li>
                                                <li><a class="dropdown-item reportdwn" data-report="0" data-type="pdf" href="#">Pdf</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li><a class="dropdown-item reportdwn" data-report="G" data-type="excel" href="#">Excel</a></li>
                                                <li><a class="dropdown-item reportdwn" data-report="G" data-type="pdf" href="#">Pdf</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $('.reportdwn').click(function(e) {
            ...
            window.open(origin + '/rafflededreport.php?drawid=' + draw_new_id + '&proid=' + reportFor + '&reportType=' + reportType + '&ticket_name=' + ticket_name + '&agdate=' + agdate);
        })
