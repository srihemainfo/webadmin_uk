...
if ($subid3 != 'permission') {
    ...
    JSON_UNQUOTE(JSON_EXTRACT(ur.vehicle_details, '$.type')) AS cab_type, 
...
$cabType = !empty($vehicleDetails['type']) 
    ? $vehicleDetails['type'] 
    : (!empty($row['cab_type']) 
        ? $row['cab_type'] 
...
?>
    ...
    <div class="form-group">
        ...
        <select class="form-control form-select" id="cab_types" name="cab_type" required title="Please select vehicle type">
            ...
            <option value="Go Mini" <?= ($cabType === 'Go Mini' || $cabType === 'Mini') ? 'selected' : '' ?>>Go Mini</option>
            <option value="Go 4Seater" <?= ($cabType === 'Go 4Seater') ? 'selected' : '' ?>>Go 4Seater</option>
            <option value="Go 6Seater" <?= ($cabType === 'Go 6Seater') ? 'selected' : '' ?>>Go 6Seater</option>
            <option value="Go 7Seater" <?= ($cabType === 'Go 7Seater' || $cabType === '7Seater') ? 'selected' : '' ?>>Go 7Seater</option>
        </select>
    </div>
</div>
                                            <div class="col-md-4">
