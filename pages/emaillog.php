...
<script>
    ...
    function searchEmail() {
        ...
        if ($.fn.DataTable.isDataTable('#email_report1')) {
            $('#email_report1').DataTable().destroy();
        }
    
        var formdate = moment(
            $('#reportrange213').data('daterangepicker').startDate._d
        ).format("MMM Do YY");
    
        var todate = moment(
            $('#reportrange213').data('daterangepicker').endDate._d
        ).format("MMM Do YY");
        ...
        if (formdate != '' && todate != '') {
            ...
            $('#email_report1').DataTable({
                ...
                // ❌ REMOVED responsive control column
                // ❌ REMOVED select checkbox config
