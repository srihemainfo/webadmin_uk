 ...
 * 9-6-2023       Prakash         Bonus Report has been developed
 */
...
<div class="main-content app-content mt-0">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="col-lg-4">
                                    <h3 class="card-title"><strong>Bonus Report</strong></h3>
                                </div>
                                <div class="col-lg-8">
                                    ...
                                    <table class="table table-bordered display" id="ticket_report" style="width:100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">Card No</th>
    ...
    <script>
        ...
        function searchTicket() {
            ...
            var title = 'Bonus Reports(' + formdate + ' to ' + todate + ')';
