 ...
 * 20/01/2023          Prakash             				Ticket Generation error Changed to toast
 * 03/02/2023          Prakash             				Ticket Permission Denied
 * 04/02/2023          Prakash             				Total
 * 13/02/2023          Prakash             				Same Ticket Recheck
 * 20/2/2023           Prakash             				Customer Create with Refresh Added
 * 21-02-2023          sathiya             				country lsit added 
 * 21.02.2023          vignesh             				dropdown-menu scroll correction
 * 1.03.2023           Prakash             				15 Seconds response not recieved  error pop up Throw
 * 2-3-2023            Prakash             				Mobile Validation Added
 * 11/05/2023          Prakash             				Draw recheck added to the agent ticket generation
 * 5-6-2023            Prakash             				Mandatory * added
 * 09-11-2023          Devanathan                       add first name and last namer- DataTable
 */
?>
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Agent Tickets</h1>
				...
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Agent Tickets</li>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" name="name" id="name" oninput="this.value = this.value.replace(/[^A-Za-z. ]/g, '');" type="text" placeholder="First Name" required>
...
<script id="rendered-js">
	...
	var url = origin + "/ajax/service/agent_services.php";
		...
		table = $("#agenttickettable").DataTable({
			...
			buttons: [
...

				{
					...
					title: 'Agent Tickets Report : (' + formdate + ' to ' + todate + ')'
...
// },
	...
	function sendotp() {
		...
		if (name != '') {
			...
			document.getElementById('createformerror').innerHTML = '<div class="alert alert-danger" role="alert">Enter First name</div>';
