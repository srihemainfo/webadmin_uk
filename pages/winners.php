	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Winners</h1>
...
<script>
	...
	var mailurl = origin + "/ajax/service/winners_email.php";
		...
		var onsuccess = function(data) {
			...
			if (response != "") {
				...
				if (response.type == 1) {
					...
					// 	let len = response.announce.length;

					// 	for (let i = 0; i < response.announce.length; i++) {
					...
					// 			value: response.announce[i]['name']
					...
					// 			value: response.announce[i]['email']
					...
					// 			value: response.announce[i]['mobile']
					...
					// 			value: response.announce[i]['subject']
					...
					// 			value: response.announce[i]['messages']
					...
					// 			value: response.announce[i]['smsmessages']
					...
					// 			value: response.announce[i]['winnerlist']
					...
					// 			value: response.announce[i]['userid']

					// 		})



					// 		var post_data2 = formdata;
					...
					// 		do_ajax_call(post_data2, onsuccess);
