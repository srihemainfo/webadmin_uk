                    ...
                    <div class="row g-3">
                            ...
                            <div class="card h-100">
                                <div class="card-header p-0">
                                    <ul class="nav nav-tabs nav-justified" role="tablist">
                                        <li class="nav-item">
                                            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#unassigned">
                                                Unassigned 
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-start shadow-sm w-100">
                                                    <li>
                                                        <a class="dropdown-item active" href="#" data-filter="all">
                                                            <i class="fa fa-list me-2 text-secondary"></i>Select Filter Type 
                                                        </a>
                                                    </li>
                                                    <li>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                    ...
                                    <div id="driverListPanel" class="d-none">
                                        <div class="bid-panel">
                                            ...
                                            <div class="bidders-wrap" id="driverListContainer">
                                                <div id="driverContainerLoader" class="text-center py-4" style="display:none">
                                                    <div class="spinner-border" role="status"></div>
                                                </div>
                                            </div>
                                ...
                                <!-- ================= RIGHT PANEL ================= -->
                                <div class="col-lg-6" id="rightPanel">
                                    <div class="card h-100" id="mapCard">
                                        <div class="card-body p-0">
                                            <!--<div id="mapContainer"-->
                                            <!--    class="d-flex align-items-center justify-content-center bg-light"-->
                                            <!--    style="height:600px;">-->
                                            <!--    <h5 class="text-muted">MAP – Driver Location</h5>-->
                                            <!--</div>-->
                                    ...
                                    <div class="card mb-2 d-none" id="driverDetailsCard">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex align-items-center mt-3">
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="small text-muted mt-1 "
                                                        ...
                                                        <span>
                                                            <i class="fa fa-check-circle text-success me-1"></i> KYC
                                                            Verified
                                                        </span>
                                            ...
                                            <div class="mt-3 small">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <strong>LMV-TR</strong> <span>
                                                            |
                                                            <strong>12 Jan 2028</strong>
                                                        </span>
                                                    </div>
                                            ...
                                            <strong>
                                                <i class="fa fa-car me-1 text-danger"></i>
                                                Vehilce Details
                                            </strong>
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div style="font-size:13px">
                                                            <strong>Go Sedan</strong> (Hyundai Aura 1.2 MT CNG) <span>
                                                    ...
                                                    <div class="mt-2 small text-muted">
                                                        ...
                                                        <div class="d-flex align-items-center gap-4 mb-1">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <i
                                                                    class="fa fa-suitcase-rolling text-secondary me-1"></i>
                                                                <strong>2 </strong>
                                                            </div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-4">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <i class="fa fa-file-contract text-success me-1"></i>
                                                                RC: <strong> 30 Nov 2026</strong>
                                                            </div>

                                                            <div class="d-flex align-items-center">
                                                                <i class="fa fa-file-alt text-danger me-1"></i>
                                                                IN: <strong> 15 Aug 2027</strong>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="mt-3 p-3 rounded d-none">
                                                ...
                                                <div class="d-flex align-items-center gap-4 small mb-2">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-check-circle text-success me-1"></i>
                                                        Accepted: <strong class="ms-1">40</strong>
                                                    </div>

                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-flag-checkered text-primary me-1"></i>
                                                        Completed: <strong class="ms-1">32</strong>
                                                    </div>

                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-times-circle text-danger me-1"></i>
                                                        Cancelled: <strong class="ms-1">05</strong>
                                                    </div>
                                                ...
                                                <div class="d-flex align-items-center gap-3 small mb-2">
                                                    ...
                                                    <div class="px-2 py-1 rounded bg-light d-flex align-items-center cursor-pointer"
                                                        ...
                                                        <i class="fa fa-flag text-danger me-1"></i>
                                                        Report: <strong class="ms-1">2</strong>
                                                    </div>
                                            ...
                                            <div class="mt-3 p-3  bg-light small">
                                                ...
                                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        Per Km: <strong class="ms-1">₹14</strong>
                                                    </div>

                                                    <!-- EXTRA KM -->
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-plus-circle text-warning me-2"></i>
                                                        Extra Km: <strong class="ms-1">₹15</strong>
                                                    </div>

                                                    <!-- ADDITIONAL HOUR -->
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-clock text-info me-2"></i>
                                                        Additional Hour: <strong class="ms-1">₹100</strong>
                                                    </div>

                                                    <!-- EXTRA DAY -->
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-calendar-plus text-success me-2"></i>
                                                        Extra Day: <strong class="ms-1">₹1200</strong>
                                                    </div>
                                    ...
                                    <div class="card mb-2 d-none" id="ownerDetailsCard">
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <!-- LEFT -->
                                                <strong>
                                                    <i class="fa fa-id-card me-1 text-danger"></i> Customer Details
                                                </strong>
                                            ...
                                            <div class="mt-1 small text-muted">
                                                ...
                                                Account Created: <strong>15 Mar 2022</strong>
                                            </div>
                                         ...
                                         <div class="mt-3 p-3 rounded">
                                                ...
                                                <div class="d-flex align-items-center gap-4 small mb-2">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <i class="fa fa-times-circle text-danger me-1"></i>
                                                        Rejected: <strong class="ms-1">05</strong>
                                                    </div>
...
function renderRequestedJobs() {
    ...
    $(document).ready(function() {
                  ...
                  <div class="col-6">
                   ...
                   <div class="col-6">
                    ...
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between pt-1 border-top">
                           <div class="text-end">
                                <div class="small text-muted">Base Fare: ₹${job.base_fare}</div>
                                <div class="small text-muted">Toll: ₹${job.toll_fare}</div>
        ...
        function renderDriversList(searchText = '') {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    res.data.forEach(driver => {
                        ...
                        // ===== PROFILE PERCENT (basic calculation) =====
                        let profilePercent = 60;
        
                        if (driver.doc_verify == 1 && driver.dl_status == 'approved') {
                            profilePercent = 90;
                        }
