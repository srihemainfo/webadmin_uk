                                          ...
                                          <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade show active" id="aadhar" role="tabpanel" aria-labelledby="aadhar-tab">
                                              <div class="card p-3 mb-3">
                                                ...
                                                <div class="image-carousel text-center">
                                                  <div class="image-box">
                                                    <img id="aadharFront" src="" class="img-fluid draggable-img" alt="Aadhar Front" style="width: 100%; height: 100%; object-fit: contain;">
                                                  </div>
                                                  <div class="image-box d-none">
                                                    <img id="aadharBack" src="" class="img-fluid draggable-img" alt="Aadhar Back" style="width: 100%; height: 100%; object-fit: contain;">
                                                  </div>
                                            ...
                                            <div class="tab-pane fade" id="dl" role="tabpanel" aria-labelledby="dl-tab">
                                              <div class="card p-3 mb-3">
                                                ...
                                                <div class="image-carousel text-center">
                                                  <div class="image-box">
                                                    <img id="dlFront" src="" class="img-fluid draggable-img" alt="DL Front" style="width: 100%; height: 100%; object-fit: contain;">
                                                  </div>
                                                  <div class="image-box d-none">
                                                    <img id="dlBack" src="" class="img-fluid draggable-img" alt="DL Back" style="width: 100%; height: 100%; object-fit: contain;">
                                                  </div>
                                            ...
                                            <div class="tab-pane fade" id="gst" role="tabpanel" aria-labelledby="gst-tab">
                                              <div class="card p-3 mb-3">
                                                ...
                                                <div class="image-carousel text-center nameboard_div mb-3">
                                                  <div class="image-box">
                                                    <img id="boardFront" src="" class="img-fluid draggable-img" alt="Name Board Front">
                                                  </div>
                                                </div>
                                           ...
                                           <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show active" id="car-verification" role="tabpanel">
                                                    <div class="card p-3 mb-3">
                                                        ...
                                                        <div class="image-carousel text-center" id="img_arr">
                                                ...
                                                <div class="tab-pane fade" id="fc" role="tabpanel">
                                                    <div class="card p-3 mb-3">
                                                        ...
                                                        <div class="image-box text-center">
                                                            <img id="fcImg" src="" class="img-fluid" alt="FC"
                                                                style="width:100%; height:auto; object-fit:cover;">
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="forms-list" id="formsList">
          <!-- JS will populate .form-row elements here -->
        </div>
      </div>
...
let statusMap = {
  pending: {
    class: 'bg-warning text-dark fs-6 px-3 py-2 rounded-pill shadow-sm',
    icon: 'fa-hourglass-half',
    text: 'Pending'
  },
  approved: {
    class: 'bg-success text-white fs-6 px-3 py-2 rounded-pill shadow-sm',
    icon: 'fa-circle-check',
    text: 'Approved'
  },
  rejected: {
    class: 'bg-danger text-white fs-6 px-3 py-2 rounded-pill shadow-sm',
    icon: 'fa-circle-xmark',
    text: 'Rejected'
  },
  default: {
    class: 'bg-secondary text-white fs-6 px-3 py-2 rounded-pill shadow-sm',
...
function showImage($carousel, index) {
  ...
  const stText = $activeBox.find('img').attr('data-img-st') || 'No Status Available';
  ...
  if ($displayElement.length) {
    ...
    if ($stElement.length) {
        ...
        let carStatus = stText || 'default';
        var { class: badgeClass, icon, text } = statusMap[carStatus] || statusMap.default;

        $stElement.attr('class', `badge fs-6 ${badgeClass}`).html(`<i class="fa-solid text-white ${icon} me-2"></i> ${text}`);
    }
}
...
function getActiveCarousel() {
  const $activeMainTab = $('.tab-content > .tab-pane.show.active');
  if (!$activeMainTab.length) return null;

  const $activePillTabContent = $activeMainTab.find('.tab-content > .tab-pane.show.active');
  
  if ($activePillTabContent.length) {
    return $activePillTabContent.find('.image-carousel').first();
  }

  return $activeMainTab.find('.image-carousel').first();
}
    ...
    function loadKycData(selectedType = "AADHAR") {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var placeholder,aadharB,aadharF = "/assets/images/loading_img.png";
                const selfieUrl = user.selfie_url?.trim() || "/assets/images/loading_img.png";
                ...
                if (selectedType == "AADHAR" || selectedType == 'AADHAR_DIGILOCKER') {
                    ...
                    $("#aadharFront").attr("src", aadharF)
                    $("#aadharBack").attr("src", aadharB)

                    if (user.proof_status === 'approval_pending' || user.proof_status === 'approved') {
                      $('#verifyToggle').prop('checked', true);
                      $('#verifyStatusLabel').html('<i class="fa-solid fa-circle-check me-2 text-white"></i> Verified');
                    } else {
                      $('#verifyToggle').prop('checked', false);
                      $('#verifyStatusLabel').html('<i class="fa-solid fa-hourglass-half me-2 text-warning"></i> Not Verified');
                    }
                    ...
                    // // console.log(dlFront, dlBack, ' hiiii')
                    ...
                    if (user.dl_status === 'approval_pending' || user.dl_status === 'approved') {
                      $('#verifyToggle').prop('checked', true);
                      $('#verifyStatusLabel').html('<i class="fa-solid fa-circle-check me-2 text-white"></i> Verified');
                    } else {
                      $('#verifyToggle').prop('checked', false);
                    ...
                    if(user.o_proof_type == 'gst'){
                        ...
                        if(user.gst_details){
                            ...
                            htmlll += `
                                    ...
                                    <hr>
                                `;
                            user.gst_details = JSON.parse(user.gst_details);
                            for (let key in user.gst_details) {
                                if (user.gst_details.hasOwnProperty(key)) {
                                    htmlll += `
                                        <div class="row mb-2">
                                            <div class="col-5 text-start fw-bold pe-2">${key}</div>
                                            <div class="col-1 text-center">:</div>
                                            <div class="col-6 text-end">${user.gst_details[key]}</div>
                                        </div>
                                    `;
                                }
                            }
                        ...
                        $("#boardFront").attr("src", user.o_proof?.trim() || placeholder);
                        $("#info-body").html(gstInfo)
                    }
                    
                    
                    
                    if (user.o_proof_status === 'approval_pending' || user.o_proof_status === 'approved') {
                        $('#verifyToggle').prop('checked', true);
                        $('#verifyStatusLabel').html('<i class="fa-solid fa-circle-check me-2 text-white"></i> Verified');
                    } else {
                        $('#verifyToggle').prop('checked', false);
                        let o_proof_status = user.o_proof_status;
                        o_proof_status = o_proof_status.charAt(0).toUpperCase() + o_proof_status.slice(1).toLowerCase();
                        
                        $('#verifyStatusLabel').html('<i class="fa-solid fa-hourglass-half me-2 text-warning"></i> ' + o_proof_status);
                    }
                }
    ...
    function loadVehicleData(txt, selectedType = 'VEHICLE'){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var placeholder = "/assets/images/loading_img.png";
                ...
                if(data.vehicle_details){
                    ...
                    if (veh) {
                        ...
                        let img_arr = $('#img_arr').empty(); // clear existing images
                        let img_html = ''; // store generated HTML
                        
                        // $.each(v_img_arr, function(index, key) {
                        Object.entries(v_img_arr).forEach(([index, key]) => {
                            let clean_text = index.replace(/_/g, ' ').replace(/url/gi, '').trim().replace(/\b\w/g, char => char.toUpperCase());
                            let img_sts = veh[key] ?? 'Unknown';
                            if (index == 'front_view_image_url') {
                                $('#data-img-alt').text(clean_text);
                                // $('#data-img-st');
                                
                                let stStatus = img_sts || 'default';
                                var { class: badgeClass, icon, text } = statusMap[stStatus] || statusMap.default;
                        
                                $('#data-img-st').attr('class', `badge fs-6 ${badgeClass}`).html(`<i class="fa-solid text-white ${icon} me-2"></i> ${text}`);
                            }
                            let img_url = veh[index] ?? placeholder;
                            
                            img_html += `
                                <div class="image-box ${index != 'front_view_image_url' ? 'd-none' : ''}">
                                    <img src="${img_url}" 
                                         class="img-fluid draggable-img" 
                                         alt="${clean_text}"
                                         style="width:100%; height:auto; object-fit:cover;" data-img-alt="${clean_text}" data-img-st="${img_sts}">
                                </div>`;
                        });
                        ...
                        switch (txt) {
                            case 'VEHICLE':
                                $('#infoTitle').text('Car Info Summary');
                                $('#expiryLabel').hide();
                                
                                let accessories = vehicle_questions?.accessories??[];
                                
                                // Icon mapping (customize icons per label)
                                let icons = {
                            ...
                            case 'PUC':
                                ...
                                $('#pucImg').attr('src', vehicle_details?.puc_details?.puc_image_url ?? placeholder);
                                $('#expiryLabel').show()
                                info_body.append(`
                                    <tr>
                                ...
                                $('#verifyStatusLabel_v')
                                  .attr('class', `badge fs-6 ${badgeClass}`)
                                  .html(`<i class="fa-solid text-white ${icon} me-2"></i> ${text}`);
                            ...
                            case 'RC':
                                ...
                                $('#rcImg').attr('src', vehicle_details?.rc_front_image_url ?? placeholder);
                                $('#expiryLabel').show()
                                ...
                                Object.entries(rcData).forEach(([key, value]) => {
                                    // Skip null or undefined values if you want
                                    if (value === null || value === undefined || value === '') return;
                            
                                    // Format the key: replace underscores → spaces → capitalize each word
                            ...
                            case 'INSURANCE':
                                ...
                                $('#expiryLabel').show()
                                $('#insuranceImg').attr('src', vehicle_details?.insurance_details?.insurance_image_url ?? placeholder);
                            ...
                            case 'FC':
                                ...
                                $('#expiryLabel').show()
                                $('#fcImg').attr('src', fc_details?.fc_image_url ?? placeholder);
                                ...
                                // // console.log(fcStatus, 'hiiii', fc_details)
