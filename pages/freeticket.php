...
10-1-2023    Prakash				Customer creation form 4 new fields added

4-2-2023     Prakash				Free ticket table total field added

17-02-2023   sathiya                live search box added country

21.02.2023    vignesh           dropdown-menu scroll correction

 2-3-2023      prakash          mobile validation added
...
if ($tabID == 'customer' || $tabID == 'offline-ticket' || $tabID == 'agent-ticket'  || $tabID == 'free-ticket') {
	...
	<div class="side-app">
		...
		<div class="main-container container-fluid">
			...
			<div class="page-header">
				...
				<h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Free Tickets</h1>
				...
				<div>
					...
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Free Tickets</li>
			...
			<?php if ($_SESSION['roll_id'] == 1 || $_SESSION['roll_id'] == 2 || $_SESSION['roll_id'] == 6) { ?>
				...
				<div class="card col-sm-12">
							...
							<div class="row g-3">
								...
								<div class="col-sm-7">
									...
									<div class="input-group mb-2" class="autocomplete">
										...
										<!-- <input id="myInput" type="text" required oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="myUser" placeholder="Searching....."> -->
					...
					<div class="card-footer text-end">
						...
						<!-- <button type="button" id="smallmodal" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#previewModal" class="btn btn-info"><i class="fe fe-plus me-2"></i>Preview</button> -->



						<!-- <button class="btn btn-success my-1" type="button" id="buybtn" onclick="registeroffline($('#totallines').val())">Submit</button> -->
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="col-lg-8">
							...
							<!-- <button type="button" id="smallmodal" data-bs-effect="effect-scale" data-bs-toggle="modal" data-bs-target="#download" class="btn btn-info"><i class="fa fa-download" aria-hidden="true"></i>Downloads</button> -->
					...
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-sm-12">
								...
								<label class="lb-text">Full Name</label><br>
								...
								<label class="lb-text">Mobile No</label><br>

								<div class="wrap-input100 validate-input input-group">



									<input id="phone" type="tel" onfocusout="Email_check()" oninput="mobile_number_validation($(this).val())" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="15">
								...
								<label class="lb-text">Email</label><br>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control req-empty" name="email" oninput="this.value = this.value.replace(/[^A-Za-z0-9@._]/g, '');" type="email" id="email" placeholder="Email" required>
								...
								<label class="lb-text">Building Name</label><br>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<div class="form-group" id="gfhdjkdk" style="width: 100%;">

										<label class="lb-text">Country</label>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<div class="form-group" style="width: 100%;">
										...
										<label class="lb-text">State / Emirates</label>
								...
								<div class="wrap-input100 validate-input input-group">
									...
									<input class="input100 border-start-0 ms-0 form-control" name="passport_expiry" type="date" min="<?= date('Y-m-d'); ?>" placeholder="Emirate / Passport ID Expiry">
...
<script>
	...
	var url = origin + "/ajax/service/free_services.php";
	...
	var onlineticketurl = origin + "/ajax/service/ot_services.php";
		...
		table = $("#agenttickettable").DataTable({
			...
			buttons: [
...

				{
					...
					title: 'Free Tickets Report : (' + formdate + ' to ' + todate + ')'
...
// },
	...
	function registeroffline(count) {
			...
			var onsuccess = function(data) {
				...
				if (response != "") {
					...
					if (response.type == 1) {
						...
						document.getElementById('rebtn').innerHTML = '<button class="btn btn-success my-1" type="button" id="buybtn" onclick="registeroffline($(' + "'#totallines'" + ').val())">Confirm</button>';
...
return false;
					...
					var onsuccess = function(data) {
						...
						if (response != "") {
							...
							if (response.type == 1) {
								...
								document.getElementById('addAgentbtn').innerHTML = '<button class="btn ripple btn-success" id="smallmodal" type="button" onclick="sendotp()">Create <?= $addName; ?></button>';
	...
	// 				document.getElementById('smserror').innerHTML = '<div class="alert alert-success" role="alert">' + response.result + '</div>';
	...
	// 				document.getElementById('smserror').innerHTML = '<div class="alert alert-danger" role="alert">' + response.result + '</div>';
