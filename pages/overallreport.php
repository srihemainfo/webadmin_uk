                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-lg-3 mb-2">
                                                <span>Select Source</span> &nbsp; <span style="color:red;">*</span>
                                                <select id="source" class="form-select">
                                                    <option value="All">All</option>
                                                    <?php
                                                    $date = date("Y-m-d");
                                                    $dateCon = "AND `createdon` BETWEEN '$date 00:00:00' AND '$date 23:59:59'";
                                                    $source = mysqli_query($con, "SELECT utm_source , COUNT(utm_source) AS 'totalviews' FROM digital_market WHERE ip IN (SELECT `ip` FROM `digital_market` WHERE `deletes` = '0'  GROUP BY ip) AND `deletes` = '0'  GROUP BY utm_source ORDER BY `utm_source` ASC;");
                                                    while ($row = mysqli_fetch_assoc($source)) {
                                                    ?>
                                                        <option value="<?= ($row['utm_source'] == '') ? 'organic' : $row['utm_source']; ?>"><?= ucfirst(($row['utm_source'] == '') ? 'organic' : $row['utm_source']); ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="col-md-2" id="serchbtn">
                                                <br>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="col-lg-4">
                                ...
                                <h3 class="card-title"><strong>Overall Report</strong></h3>
            ...
            table = $("#dm_report").DataTable({
                ...
                buttons: [
                    ...
                    'csv',
                    {
                        ...
                        title: 'Overall Reports (' + formdate + ' to ' + todate + ')'
