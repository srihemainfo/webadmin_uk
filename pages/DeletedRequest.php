   ...
   <div class="side-app">
      ...
      <div class="main-container container-fluid">
         ...
         <div class="page-header">
            <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Customer Account Delete Request</h1>
            <div>
               <ol class="breadcrumb">
                                 ...
                                 <div class="col-lg-3 col-sm-6 mb-2">
                                  ...
                                  <div class="col-lg-3 col-sm-6 mb-2">
                                     ...
                                     <select id="userType" class="form-control">
                                         ...
                                         <option value="1">Reactivated</option>
         ...
         <div class="col-lg-12">
            <div class="card">
               <div class="card-header">
                  <div class="col-lg-4">
                     <h3 class="card-title"><strong>Delete Requests</strong></h3>
                  </div>
                  <div class="col-lg-8">
                  </div>
               </div>
                     ...
                     <table class="table table-bordered text-nowrap border-bottom" id="sms_report1" style="width:100%;">
                        <thead>
                           <tr>
                              ...
                              <th class="wd-15p border-bottom-0">Deleted Request on Date</th>
                              <th class="wd-20p border-bottom-0">Status</th>
                              <th class="wd-20p border-bottom-0">Deleted AT</th>
                              <th class="wd-20p border-bottom-0">Account Expire Date</th>
                              <!--<th class="wd-20p border-bottom-0">Deleted BY Name</th>-->
...
<script>
   ...
   function searchTicket() {
      ...
      var title = 'Customer Account Deleted Request : (' + formdate + '  to  ' + todate + ') ' ;
