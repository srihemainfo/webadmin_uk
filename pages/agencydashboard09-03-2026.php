...
<div class="offcanvas offcanvas-end" tabindex="-1" id="driverEditDrawer">
    <div class="offcanvas-header border-bottom d-flex justify-content-between p-3 bg-white">
        ...
        <div class="d-flex align-items-center gap-2">
            <button class="btn btn-light" type="button" id="closeDrawerBtn" title="Close">
                <i class="fa fa-times"></i>
            </button>
        </div>
    </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-4">
                        ...
                        <div class="view-mode" id="view-driver-profile">
                            ...
                            <div class="d-flex align-items-start justify-content-between mb-3">
                                ...
                                <div class="d-flex gap-3 flex-grow-1">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <strong>Name:</strong>
                                            <span class="display-field" data-field="name">Venkatesan</span>
                                        </div>
                                        <!-- Age + Email -->
                                        <div class="row">
                                            <div class="col-5">
                                                <i class="fa fa-calendar text-secondary me-1"></i>
                                                <span class="display-field" data-field="age">35 Years</span>
                                            </div>
                                            <div class="col-7">
                                                <i class="fa fa-envelope text-danger me-1"></i>
                                                <span class="display-field" data-field="email">driver@mail.com</span>
                                            </div>
                                            <div class="col-6">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <span id="display_experience">5 </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex gap-2 ">
                                    <a href="tel:9876543210" class="call-icon" title="Call">
                                        <i class="fa fa-phone text-primary"></i>
                                    </a>
                                    <a href="https://wa.me/919876543210" class="whatsapp-icon" title="WhatsApp">
                                        <i class="fab fa-whatsapp text-success"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="mb-2">
                                <i class="fa fa-address-card text-dark me-1"></i>
                                <span class="display-field" data-field="address">
                                    123, Anna Salai, T. Nagar, Chennai - 600017
                                </span>
                            </div>
                            <!-- State + City -->
                            <div class="row mb-2">
                                ...
                                <div class="col-6">
                                    <i class="fa fa-globe text-info me-1"></i>
                                    <span class="display-field" data-field="state">Tamil Nadu</span>
                                </div>
                            </div>
                            <!-- Languages -->
                            <div>
                                <i class="fa fa-language text-dark me-1"></i>
                                <strong>Languages:</strong>
                                <span class="display-field" data-field="languages">
                                    Tamil | English | Telugu
                                </span>
                            </div>
                        </div>
                        <!-- EDIT MODE - Driver Profile -->
                        <div class="edit-mode" id="edit-driver-profile" style="display: none;">
                            <div class="row g-2">
                                <div class="col-5">
                                    <label class="form-label fw-semibold mb-1">Name</label>
                                    <input type="text" class="form-control form-control-sm edit-field" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g,'').slice(0,65)" id="edit_name"
                                        data-field="name" value="Venkatesan">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Age</label>
                                    <input type="text" class="form-control form-control-sm edit-field" oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,3)" id="edit_age"
                                        data-field="age" value="35">
                                </div>
                                <div class="col-4">
                                    <label class="form-label fw-semibold mb-1">Mobile</label>
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_mobile" oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,12)"
                                        data-field="mobile" value="9876543210">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Email</label>
                                    <input type="email" class="form-control form-control-sm edit-field" id="edit_email" oninput="this.value = this.value.replace(/[^a-zA-Z0-9@._-]/g,'').slice(0,75)" value="">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">Driver Exp *</label>
                                    <input type="number" class="form-control form-control-sm" id="edit_experience" oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,3)"
                                        value="5">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">City</label>
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_city"
                                        data-field="city" value="Chennai">
                                </div>
                                <div class="col-3">
                                    <label class="form-label fw-semibold mb-1">State</label>
                                    <select class="form-control form-select" id="edit_state" data-field="state" title="Please select a state">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm edit-field" id="edit_address" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g,'').slice(0,150)"
                                        data-field="address" value="123, Anna Salai, T. Nagar, Chennai - 600017">
                                </div>
                                <div class="col-6">
                                    <label class="form-label fw-semibold mb-1">Languages</label>
                                    <select class="selectpicker edit-field" id="edit_languages" data-live-search="true" data-actions-box="true" data-field="languages" multiple size="2">
                                        <?php
                                ...
                                <div class="col-12 mt-2 text-end">
                                    <button class="btn btn-sm btn-success me-2 save-section"
                                        data-section="driver-profile"><i class="fa fa-save me-1"></i>Save</button>
                                    <button class="btn btn-sm btn-secondary cancel-section"
                                        data-section="driver-profile"><i class="fa fa-times me-1"></i>Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-id-card text-danger me-2"></i>Aadhaar Card</h6>
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-id-card text-danger me-2"></i>Driving License</h6>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="date" class="form-control form-control-sm edit-field"
                                        id="edit_license_expiry" value="2028-12">
                                </div>
                                <div class="col-12 mt-2 text-end">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-car text-danger me-2"></i>Vehicle Details</h6>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="text-center mb-3 position-relative" id="viewer-vehicle">
                                    <div class="image-wrapper">
                                        <img src="assets/images/carimage3.png" alt="Vehicle"
                                            class="cursor-pointer vehicle-photo viewable-image">
                                    </div>
                                    <div class="upload-overlay-small" data-target="vehicle-photo">
                                        <i class="fa fa-camera text-primary"></i>
                                        <input type="file" class="file-input-hidden" accept="image/*"
                                            data-target="vehicle-photo">
                                    </div>
                                </div>
                            </div>
                            <div class="col-8">
                                ...
                                <div class="view-mode" id="view-vehicle">
                                    ...
                                    <div class="mb-2">
                                        <strong class="text-dark">
                                            <span id="display_vehicle_type">Go Sedan</span>
                                        </strong>
                                        <span class="text-muted">
                                            (<span id="display_maker_model">Hyundai Aura 1.2 MT CNG</span>)
                                        </span>
                                    ...
                                    <div class="d-flex flex-wrap gap-3 mb-2 ">
                                        <div>
                                            ...
                                            <span id="display_seating">4+1</span>
                                        </div>
                                        <div>
                                            <i class="fa fa-gas-pump text-warning me-1"></i>
                                            <span id="display_fuel">Petrol</span>
                                        </div>
                                        <div>
                                            <i class="fa fa-suitcase text-secondary me-1"></i>
                                            <span id="display_luggage">2</span>
                                        </div>
                                    </div>
                                    <!-- Row 3 -->
                                    <div class="d-flex flex-wrap gap-4 ">
                                        <div>
                                            <i class="fa fa-file text-info me-1"></i>
                                            RC:
                                            <span id="display_rc">30 Nov 2026</span>
                                        </div>
                                        <div>
                                            <i class="fa fa-file text-danger me-1"></i>
                                            IN:
                                            <span id="display_insurance">15 Aug 2027</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- EDIT MODE -->
                                <div class="edit-mode" id="edit-vehicle" style="display:none;">
                                    <div class="row g-3">
                                        <!-- Row 1 -->
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">Vehicle Type</label>
                                            <select class="form-select form-select-sm" id="edit_vehicle_type">
                                        ...
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">Maker Model</label>
                                            <input type="text" class="form-control form-control-sm" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g,'').slice(0,25)"
                                                id="edit_maker_model" value="Hyundai Aura 1.2 MT CNG">
                                        </div>
                                        <!-- Row 2 -->
                                        <div class="col-4">
                                            <label class="form-label fw-semibold">Fuel Type</label>
                                            <select class="form-select form-select-sm" id="edit_fuel">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm" oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,3)" id="edit_seating"
                                                value="4+1">
                                        </div>
                                        <!-- Row 3 -->
                                        <div class="col-4">
                                            <label class="form-label fw-semibold">Luggage</label>
                                            <input type="text" class="form-control form-control-sm" oninput="this.value = this.value.replace(/[^0-9]/g,'').slice(0,3)" id="edit_luggage"
                                                value="2">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">RC Valid Until</label>
                                            <input type="date" class="form-control form-control-sm" id="edit_rc" min="<?php echo $today; ?>">
                                        </div>
                                        <!-- Row 4 -->
                                        <div class="col-6">
                                            <label class="form-label fw-semibold">Insurance Valid Until</label>
                                            <input type="date" class="form-control form-control-sm" id="edit_insurance" min="<?php echo $today; ?>">
                                        </div>
                                        <!-- Buttons -->
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-file text-danger me-2"></i>Vehicle Documents</h6>
                ...
                <div class="row">
                    <div class="col-5 d-none">
                        ...
                        <div class="card shadow-sm border-0 mb-3">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <h6 class="mb-0 fw-bold"><i class="fa fa-images text-danger me-2"></i>Vehicle
                                        Gallery</h6>
                                    <i class="fa fa-edit text-dark cursor-pointer edit-section-trigger"
                    ...
                    <div class="col-12">
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    <h6 class="mb-0 fw-bold"><i class="fa fa-rupee text-danger me-2"></i>Fare Rates</h6>
                                    <i class="fa fa-edit text-dark cursor-pointer edit-section-trigger"
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            ...
                                            <input type="number" class="form-control form-control-sm edit-field"
                                                id="edit_per_km" data-field="per_km" value="14">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold mb-1">Extra KM (₹)</label>
                                            <input type="number" class="form-control form-control-sm edit-field"
                                                id="edit_extra_km" data-field="extra_km" value="15">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold mb-1">Extra Hour (₹)</label>
                                            <input type="number" class="form-control form-control-sm edit-field"
                                                id="edit_extra_hour" data-field="extra_hour" value="100">
                                        </div>
                                        <div class="col-6">
                                            <label class="form-label fw-semibold mb-1">Extra Day (₹)</label>
                                            <input type="number" class="form-control form-control-sm edit-field"
                                                id="edit_extra_day" data-field="extra_day" value="1200">
                                        </div>
                                        <div class="col-12 mt-2 text-end">
                                            <button class="btn btn-sm btn-success me-2 save-section"
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-credit-card text-danger me-2"></i>Payment Methods
                            </h6>
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-calendar-alt text-danger me-2"></i>Scheduled Jobs
                            </h6>
                        ...
                        <div class="view-mode" id="view-jobs">
                            <div class="schedule-list" id="scheduledJobsList">
                                <div
                        ...
                        <div class="edit-mode" id="edit-jobs" style="display: none;">
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Job 1</label>
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control form-control-sm" id="edit_job1_route"
                                        value="Chennai → Salem">
                                    <input type="text" class="form-control form-control-sm" id="edit_job1_time"
                                        value="Today 10:30 AM" style="width: 140px;">
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-semibold">Job 2</label>
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control form-control-sm" id="edit_job2_route"
                                        value="Salem → Coimbatore">
                                    <input type="text" class="form-control form-control-sm" id="edit_job2_time"
                                        value="Tomorrow 2:00 PM" style="width: 140px;">
                                </div>
                            </div>
                            <div class="text-end mt-2">
                                <button class="btn btn-sm btn-success me-2 save-section" data-section="jobs"><i
                                        class="fa fa-save me-1"></i>Save</button>
                                <button class="btn btn-sm btn-secondary cancel-section" data-section="jobs"><i
                                        class="fa fa-times me-1"></i>Cancel</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card shadow-sm border-0 mb-3">
                    <div class="card-body p-3">
                        ...
                        <!-- VIEW MODE -->
                        <div class="view-mode" id="view-activity">
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <h6 class="mb-0 fw-bold"><i class="fa fa-comment text-danger me-2"></i>Admin Remarks</h6>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="driverPreviewCanvas">
    ...
    <div class="offcanvas-body p-0">
        <div class="card mb-2" id="driverDetailsCard">
    ...
    <span id="driver_name">Venkatesan</span> <span id="driver_no"></span>
    <a href="#" class="text-warning" title="Edit Driver" id="driver_profile_edit">
        <i class="fa fa-edit text-info"></i>
    </a>
    <i class="fa-solid fa-message cursor-pointer ms-2" id="sidebar_remarks_icon" style="color: #6c757d; font-size: 1.15rem;" title="Add/View Remarks" onclick="openSidebarRemarks()"></i>
</div>
                            <div class="d-inline-flex align-items-center gap-2">
                                <a href="tel:9876543210" class="call-con"
                                    title="Call Owner">
                ...
                <div class="mt-3">
                    <div class="d-flex justify-content-between align-items-center small mb-1">
                        ...
                        <span id="profilePercentText">0%</span>
                    </div>
                    <div class="progress" style="height:8px;">
                        <div id="profileProgressBar"
                            class="progress-bar"
                            role="progressbar"
                            style="width:0%"
                            aria-valuemin="0"
...
<div class="modal fade" id="remarksModal" tabindex="-1" aria-hidden="true" style="z-index: 1080;">
...
`;
        ...
        function normalizeJob(job, source) {
            ...
            return {
                ...
                name: (userDetails.name && userDetails.name.trim() !== '') ?
                    userDetails.name :
                    (job.poster_name && job.poster_name.trim() !== '') ?
                    job.poster_name :
                    '-',
    ...
    // ADD THIS LINE: Store the ID directly in the remarks icon
    $('#sidebar_remarks_icon').attr('data-driver-id', d.user_id);
}
                    if (d.name) {
                    ...
                    if (d.mobile) {
                        const cleanMobile = String(d.mobile).replace(/\D/g, '');
                        $('#driverDetailsCard #driver_no').text('(' + cleanMobile + ')');
                        $('#driverDetailsCard .call-con')
                            .attr('href', `tel:${cleanMobile}`);
                        $('#driverDetailsCard .whatsapp-icon')
                            .attr('href', `https://wa.me/${cleanMobile}`);
                    }
                    if (d.profile_percentage !== undefined && d.profile_percentage !== null) {
                        let percent = parseInt(d.profile_percentage) || 0;
                        percent = Math.max(0, Math.min(100, percent));
                        $('#profilePercentText').text(percent + '%');
                        $('#profileProgressBar')
                            .css('width', percent + '%')
                            .attr('aria-valuenow', percent)
                            .removeClass('bg-success bg-warning bg-danger');
                        if (percent < 40) {
                            $('#profileProgressBar').addClass('bg-danger');
                        } else if (percent < 75) {
                            $('#profileProgressBar').addClass('bg-warning');
                        } else {
                            $('#profileProgressBar').addClass('bg-success');
                        }
                    }
                    if (d.doc_verify == 1) {
                    ...
                    if (d.extra_per_km) {
                        $('#driverDetailsCard .fa-plus-circle')
                            .parent()
                            .find('strong')
                            .text(`₹${d.extra_per_km}`);
                    }
                    if (d.per_hour) {
                        $('#driverDetailsCard .fa-clock')
                            .parent()
                            .find('strong')
                            .text(`₹${d.per_hour}`);
                    }
        ...
        function openDriverEditDrawer(id) {
            ...
            $('#driverEditLoader').removeClass('d-none');
            $.ajax({
                url: "<?= rtrim(TEST_API_DOMAIN_2, '/') ?>/admin-get-driver-details",
                type: "POST",
                dataType: "json",
                ...
                success: function(res) {
                    ...
                    const d = res.data.driver || {};
                    const vehicleData = JSON.parse(d.vehicle_details || '{}');
                    ...
                    if (langs) {
                        ...
                        $('#edit_languages')
                            .selectpicker('val', langArr)
                            .selectpicker('refresh');
                    } else {
                        $('#edit_languages').selectpicker('refresh');
                    }
                    ...
                    function setImage(selector, url) {
                        if (url) {
                            $(selector).attr('src', url).show();
                        } else {
                            $(selector).hide();
                            // $(selector).attr('src', 'assets/images/placeholder.png').show();
                        }
                    }
                    ...
                    setText('[data-field="state"].display-field', d.state || '-');
                    
                    if (d.state && d.state.trim() !== '') {
                        $('#edit_state').val(d.state.trim());
                    }
                    
                    setText('#display_experience', d.exp ? d.exp + " Years" : "0 Years");
                    setVal('#edit_experience', d.exp);
                    
                    setText('#display_upi', d.upiID);
                    setVal('#edit_upi', d.upiID);
                    
                    $('#profileScoreBadge').html(
                        `<i class="fa fa-check-circle me-1"></i>${d.profile_percentage || 0}% Complete`
                    );
                    /* =========================
                       PROFILE IMAGE
                    ========================== */
                    if (d.profile_img_url) {
                        setImage('.driver-photo', d.profile_img_url);
                    } else if (d.selfie_url) {
                        setImage('.driver-photo', d.selfie_url);
                    } else {
                        setImage('.driver-photo', null);
                    }
                    /* =========================
                       AADHAAR
                    ========================== */
                    if (d.proof_type === 'AADHAR_DIGILOCKER' && d.proof_status === 'approved') {
                        setImage('#aadhaarFront img', '/assets/images/digiverify.png');
                        setImage('#aadhaarBack img', '/assets/images/digiverify.png');
                    } else {
                        setImage('#aadhaarFront img', d.aadhar_image_front);
                        setImage('#aadhaarBack img', d.aadhar_image_back);
                    ...
                    /* =========================
                       LICENSE / RC
                    ========================== */
                    setImage('#licenseFront img', d.license_front_image);
                    setImage('#licenseBack img', d.license_back_image);
                    ...
                    const fuel = vehicleData.vehicle_questions?.fuel_type;
                    setText('#display_fuel', fuel);
                    setVal('#edit_fuel', fuel);
                    ...
                    const seat = vehicleData.rc_details?.response?.vehicle_details?.seat_capacity;
                    var disSeat = 0;
                    if (seat > 1) {
                        disSeat = (seat - 1) + " + 1";
                    } else {
                    ...
                    setVal('#edit_seating', seat);
                    /* =========================
                       RC Expiry
                    ========================== */
                    if (vehicleData.rc_expiry_date) {
                        const formatted = formatDateSimple(vehicleData.rc_expiry_date);
                        const formatted2 = formatDateSimple(vehicleData.insurance_details?.insurance_exp_date);
                        setText('#display_rc', formatted);
                        setText('#display_insurance', formatted2);
                    ...
                    /* =========================
                       VEHICLE MAIN IMAGE
                    ========================== */
                    setImage('.vehicle-photo', vehicleData.vehicle?.front_view_image_url);
                    setImage('#mainGalleryImage', vehicleData.vehicle?.front_view_image_url);
                    setText('#galleryCount', 1);
                    /* =========================
                       VEHICLE DOCUMENTS
                    ========================== */
                    setImage('#rcDocumentFront img', vehicleData.rc_front_image_url);
                    setImage('#rcDocumentBack img', vehicleData.rc_back_image_url);
                    setImage('#pucDocument img', vehicleData.puc_details?.puc_image_url);
                    setImage('#insuranceDocument img', vehicleData.insurance_details?.insurance_image_url);
                    setImage('#edit-rcDocumentFront img', vehicleData.rc_front_image_url);
                    setImage('#edit-rcDocumentBack img', vehicleData.rc_back_image_url);
                    setImage('#edit-pucDocument img', vehicleData.puc_details?.puc_image_url);
                    setImage('#edit-insuranceDocument img', vehicleData.insurance_details?.insurance_image_url);
...
<div class="bid-item mb-2 p-2">
    <div class="d-flex align-items-center gap-2">
        ...
        function getSectionData(section, driverId) {
            ...
            switch (section) {
                case 'driver-profile':
                    ...
                    let langs = $('#edit_languages').selectpicker('val') || [];
                    ...
                    if (mobile.length < 10) {
                        showNotification('Mobile number must be at least 10 digits', 'error');
                        return false;
                    }
                ...
                case 'fare':
                    data = {
                        ...
                        per_km: $('#edit_per_km').val(),
                        extra_per_km: $('#edit_extra_km').val(),
                        per_hour: $('#edit_extra_hour').val(),
                        per_day: $('#edit_extra_day').val()
                    };
                    break;
                case 'payment':
                    data = {
                    ...
                    break;
                    case 'vehicle':
                        let vehicle_type = $('#edit_vehicle_type').val();
                        let maker_model = $('#edit_maker_model').val();
                        let fuel = $('#edit_fuel').val();
                        let seating = $('#edit_seating').val();
                        let luggage = $('#edit_luggage').val();
                        let rc_expiry = $('#edit_rc').val();
                        let insurance_expiry = $('#edit_insurance').val();
                    
                        if (!vehicle_type) {
                            showNotification('Vehicle type is required', 'error');
                            return false;
                        }
                    
                        if (!maker_model) {
                            showNotification('Maker model is required', 'error');
                            return false;
                        }
                    
                        if (!fuel) {
                            showNotification('Fuel type is required', 'error');
                            return false;
                        }
                    
                        if (!seating) {
                            showNotification('Seating capacity is required', 'error');
                            return false;
                        }
                    
                        if (!luggage) {
                            showNotification('Luggage capacity is required', 'error');
                            return false;
                        }
                    
                        if (!rc_expiry) {
                            showNotification('RC expiry date is required', 'error');
                            return false;
                        }
        ...
        function updateSectionDisplay(section) {
            switch (section) {
                case 'driver-profile':
                    $('[data-field="name"]').text($('#edit_name').val());
                    $('[data-field="mobile"]').text($('#edit_mobile').val());
                    $('[data-field="address"]').text($('#edit_address').val());
                    $('[data-field="state"]').text($('#edit_state').val());
                    $('[data-field="age"]').text($('#edit_age').val());
                    $('[data-field="email"]').text($('#edit_email').val());
                    $('#display_experience').text($('#edit_experience').val() + " Years");
                    
                    const langs = ($('#edit_languages').val() || []).join(' | ');
                    $('[data-field="languages"]').text(langs);
        ...
        $(document).on('click', '.save-section-img[data-section="aadhaar"]', async function() {
            ...
            if (!aadhaarFrontUrl || !aadhaarBackUrl) {
                alert("Both Aadhaar Front and Back images are mandatory.");
                return;
            }
            try {
        ...
        $(document).on('click', '.save-section-img[data-section="license"]', async function() {
            ...
            const dob = $('#edit_license_dob').val(); // YYYY-MM-DD
            const expiryMonth = $('#edit_license_expiry').val(); // YYYY-MM
            if (!dlNo || !dob || !expiryMonth) {
                showNotification("DL No, DOB and Expiry are mandatory", 'danger');
                return;
            }
            const expiry = expiryMonth + "-01"; // Convert month → full date
            const btn = $(this);
            ...
            try {
                ...
                if (response.status) {
                    ...
                    if (dlFrontUrl)
                        $('#licenseFront img').attr('src', dlFrontUrl);
                    if (dlBackUrl)
                        $('#licenseBack img').attr('src', dlBackUrl);
        ...
        $(document).on('click', '.save-section-img[data-section="documents"]', async function() {
            ...
            if (!rcNumber || !rcExpiry || !rcFrontUrl || !rcBackUrl) {
                showNotification("RC Front and Back images, RC Number and Expiry required", 'danger');
                return;
            }
            const btn = $(this);
            ...
            try {
                ...
                if (rcFrontUrl)
                    $('#rcDocumentFront img').attr('src', rcFrontUrl);
                if (rcBackUrl)
                    $('#rcDocumentBack img').attr('src', rcBackUrl);
                if (pucUrl)
                    $('#pucDocument img').attr('src', pucUrl);
                if (insuranceUrl)
                    $('#insuranceDocument img').attr('src', insuranceUrl);
  ...
  <div class="border  p-3 ">
    ...
    const vehicleViewer = new Viewer(
        document.getElementById('viewer-vehicle'), {
            toolbar: true,
            navbar: false,
            fullscreen: true,
            zIndex: 9999
...
<script>
    ...
    $(document).on('keypress', '#passengers', function(e) {
        if (e.which < 48 || e.which > 57) {
            e.preventDefault();
            return false;
        }
        // Prevent typing '0' as the very first character
        if (this.value.length === 0 && e.which === 48) {
            e.preventDefault();
            showValidationToast('Passengers cannot be 0');
            return false;
        }
        ...
        const char = String.fromCharCode(e.which);
        let predictedStr = window.getSelection().toString() === this.value ? char : this.value + char;
        if (parseInt(predictedStr, 10) > 15) {
            e.preventDefault();
            showValidationToast('Maximum allowed limit is 15');
            return false;
        }
    });
    $(document).on('input', '#passengers', function() {
        ...
        if (val !== '') {
            ...
            if (num === 0) val = ''; // Clears if they somehow paste "000"
            else if (num > 15) val = '15';
            else val = num.toString(); // Removes leading zeros (e.g., "05" becomes "5")
        }
        if (this.value !== val) this.value = val;
    });
    // 6. LUGGAGE: Max 15
    $(document).on('keypress', '#luggage', function(e) {
        if (e.which < 48 || e.which > 57) {
            e.preventDefault();
            return false;
        }
    ...
    $(document).on('input', '#luggage', function() {
        ...
        if (val !== '') {
            let num = parseInt(val, 10);
            if (num > 15) val = '15';
            else val = num.toString(); // Trims "0000" down to just "0"
        }
        if (this.value !== val) this.value = val;
    });
