   ...
   <div class="side-app">
      ...
      <div class="main-container container-fluid">
         ...
         <div class="page-header">
            <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Deleted Tickets</h1>
            <div>
               <ol class="breadcrumb">
            ...
            <div class="col-lg-12">
               <div class="card">
                  <div class="card-header">
                     <div class="col-lg-4">
                        <h3 class="card-title"><strong>Deleted Tickets</strong></h3>
                     </div>
                     <div class="col-lg-8">
                     </div>
                  </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom" id="sms_report1" style="width:100%;">
                           <thead>
                              <tr>
                                 ...
                                 <th class="wd-15p border-bottom-0">Deleted Reason</th>
...
<script>
   ...
   var url = origin + "/ajax/service/delete_service.php";
       	...
       	// 	alert(response);
       		if (response != "") {
       			if (response.type == 1) {
       			    ...
       			    swal.fire({
                                title: 'Success',
                                text: 'Ticket Revoked successful',
                                icon: 'success',
