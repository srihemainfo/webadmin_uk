<!--
   ...
   //  04-06-2024   Devanathan          Page creation
...
<?php
   ...
   //   }
      ...
      <?php
$Coupon_name = mysqli_query($con, "SELECT discount_name,id FROM `discount_periods` WHERE id != '';");
   ...
   <div class="side-app">
      <div class="main-container container-fluid">
         <div class="page-header">
            <h1 class="page-title"><a href="javascript:void(0)" class="back-arrow-btn"><i class="fa fa-chevron-left" onclick="history.go(-1)" aria-hidden="true"></i></a>Discount History</h1>
            <div>
               <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="" id="anchor">Home</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Discount History</li>
               </ol>
            </div>
         </div>
      </div>
               ...
               <div class="card-header">
                  <div class="row">
                     <div class="col-12 mb-2">
                        <h3 class="card-title"><strong>Discount History</strong></h3>
                     </div>
                     ...
                     <div class="col-md-10   col-lg-4  mb-2">
                          ...
                          <span>Select Discount Offer Name</span> &nbsp; <span style="color:red;"></span>
                                    <select id="searchTxt" class="form-control">
                                       <option value="" selected>Select name</option>
                                       <?php foreach ($output as $item) : ?>
                                          <option value="<?php echo $item['id']; ?>"><?php echo $item['discount_name']; ?></option>
                                       <?php endforeach; ?>
                                    </select>
                        <!--<span>Search </span>-->
                     ...
                     <table class="table table-bordered text-nowrap border-bottom" id="wtickettable" style="width:100%;">
                        <thead>
                           <tr>
                              ...
                              <th class="wd-20p border-bottom-0">Product(AED)</th>
                              <th class="wd-20p border-bottom-0">Discount(AED)</th>
                              <th class="wd-20p border-bottom-0">Start Date</th>
                              <th class="wd-15p border-bottom-0">End Date</th>
                              <th class="wd-25p border-bottom-0">Limitations</th>
...
<script>
   ...
   function viewtable() {
    ...
    var title = 'Discount Ticket History : (' + formdate + '  to  ' + todate + ')';
    ...
    var table = $("#wtickettable").DataTable({
      ...
      info: true,
      ajax: {
        url: origin + "/ajax/service/DiscountOffers_services.php",
        method: "POST",
        dataSrc: "",
        data: {
          method: 'list_Discount_history',
          formdate: formdate,
          todate: todate,
          couponid: couponid,
          search_id: search_id,
        ...
        // },
        {
       ...
       
         {
                ...
                render: function(data, type, row, meta) {
                    ...
                    <a target="_blank" href="<?= $adminurl; ?>discounttickets/list/${data.id}" class="btn text-secondary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="View Tickets">
