                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap border-bottom" id="exampleTable"
                                    style="width:100%;">
                                    <thead>
                                        <tr>
    ...
    function viewtable() {
        ...
        if (datefrom == '' || datefrom != '' || datefill != '' || datefill == '' || fieldname != '' || deletedstatus != '' || deletedstatus == '') {
            ...
            if (tabID == 'agents') {
                ...
                table = $("#exampleTable").DataTable({
                    ...
                    ajax: {
                       ...
                       data: {
                            ...
                            deletedstatus: deletedstatus,
                            user_type: user_type_filter // Send new filter to backend
                        }
                    },
                    dom: 'Bfrtip',
                    lengthMenu: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            let kycButton = '';
                            if (data.kyc_id) {
                                kycButton = `&nbsp;&nbsp;<a href="https://console.goride.run/kyc-verify/verify/${data.nid}/${data.kyc_id}" target="_blank" style="cursor: pointer;" title="KYC Verification"><span class="fa fa-id-card" style="color: #198754;font-size: 16px;font-weight: bold;">&nbsp;Kyc</span></a>`;
                            }

                            return `
                                <a class="btn text-danger btn-sm" data-bs-target="#deleteinfo" data-bs-toggle="modal" data-bs-toggle="tooltip" style="cursor: pointer;" data-bs-original-title="Delete"><span class="fe fe-trash-2" style="color: #ff0000;font-size: 16px;font-weight: bold;" onclick=deletelist('${data.nid}')></span></a>&nbsp;&nbsp;
                                <a href="/profile/edit/${data.nid}" style="cursor: pointer;"><span class="fa fa-eye" style="color: #49117cc9;font-size: 16px;font-weight: bold;">&nbsp;Profile</span></a>
                                ${kycButton}
                            `;
                        }
                    }
                ...
                if ((datefrom != '' || datefill != '') && (deletedstatus == 1 && deletedstatus != "")) {
                    var excelTitle = 'Field Officers User List : (' + fieldname + ' ' + "Deleted <?= $addName; ?>" + ' ' + datefrom + ' to ' + datefill + ')';
                } else if ((datefrom != '' || datefill != '') && (deletedstatus == 0 && deletedstatus != "")) {
                    var excelTitle = 'Field Officers List : (' + fieldname + ' ' + "Active <?= $addName; ?>" + ' ' + datefrom + ' to ' + datefill + ')';
                } else if (datefrom != '' || datefill != '') {
                    var excelTitle = 'Field Officers List : (' + fieldname + ' ' + datefrom + ' to ' + datefill + ')';
                } else if (deletedstatus == 1) {
                    var excelTitle = 'Field Officers List : (' + fieldname + ' ' + "Deleted <?= $addName; ?>" + ')';
                } else if (deletedstatus == "") {
                    var excelTitle = 'Field Officers List : (all data)';
                } else if (deletedstatus == 0) {
                    var excelTitle = 'Field Officers List : (' + fieldname + ' ' + "Active <?= $addName; ?>" + ')';
                }
