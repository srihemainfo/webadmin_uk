    ...
    <div class="side-app">
        <div class="main-container container-fluid mt-4">
            ...
            <div class="d-flex flex-wrap gap-2 mb-3" id="carpoolStatusTabs">
                ...
                <button class="btn bg-white shadow-sm border-0 fw-bold text-muted carpool-status-tab px-4 py-3" data-tab="scheduled" style="border-radius: 6px;">
                    Scheduled Go Car Pool Jobs
                </button>
                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-md-10">
                            <div class="row g-2 justify-content-end align-items-center">
                                ...
                                <div class="col-md-2">
                                    <select id="carpoolRoleFilter" class="form-select form-select-sm shadow-none fw-semibold text-dark border-light" style="background-color: #f8f9fa;">
...
<script>
    $(document).ready(function() {
        ...
        function renderCarpoolList(typeFilter, tabType) {
            ...
            // FIX: Always hide the empty state before applying new filters
            $('#carpoolEmpty').addClass('d-none');
            ...
            const roleFilter = $('#carpoolRoleFilter').val();
            if (roleFilter !== 'all') {
                jobsToRender = jobsToRender.filter(job => {
                    const isDriver = (job.global_type === 'dr_carpool');
                    return roleFilter === 'driver' ? isDriver : !isDriver;
                });
            }

            // If no jobs match the filter, show the empty state and stop
        ...
        $(document).on('change', '#carpoolRoleFilter', function() {
            renderCarpoolList($('#carpoolFilterType').val(), carpoolTabType);
        });
        ...
        function generateCarpoolCard(job, tabType) {
            ...
            // Determine if the user is a Driver or Customer based on global_type
