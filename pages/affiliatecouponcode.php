<?php
    ...
    *      13/03/2024      Devanathan         Affiliate Coupon Code
    * 
    * */
                              ...
                              <div class="mt-2">
                                 <div class="row">
                                    <div class="col-lg-3 col-sm-6 mb-2">
                                       <label for="searchtxt"><strong>Coupon Name</strong><i style="color: red;">*</i></label>
                                       <div class="pt-5">
                                    ...
                                    <!--<div class="col-lg-3 col-sm-6 mb-2">
                                       ...
                                       <div class="d-flex align-items-center">
                                           <input class="form-control" type="text" name="ccode" id="ccode" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '');" minlength="10" maxlength="15" style="text-transform: uppercase">&nbsp;<i onclick="get_new_coupon()" class="fa fa-refresh" aria-hidden="true"></i>
                                       </div>
                                       </div>-->
                                    <!--<div class="col-lg-3 col-sm-6 mb-2">-->
                                    <!--   <label for="searchtxt"><strong>Select Affiliate User</strong><i style="color: red;">*</i></label>-->
                                    <!--   <div class="pt-5">-->
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-2">
                                       <label for="searchtxt"><strong>Used BY</strong><i style="color: red;">*</i></label>
                                       <div class="pt-5">
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-2">
                                       <label for="searchtxt"><strong>No. of Coupon(Max 100 Coupon at once)</strong><i style="color: red;">*</i></label>
                                       <div class="pt-5">
                                          <input class="form-control" type="number" name="totcoupon" id="totcoupon" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="3">  
                                       </div>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 mb-2">
                                       <label for="searchtxt"><strong>Coupon Value</strong><i style="color: red;">*</i></label>
                                       <div class="pt-5">
                                          <select id="camt" class="form-select">
                                             <?php
                                                $product = select_query($con, "product", "", "`deletes`='0' AND `type`='PRODUCT'  ORDER BY `id` ASC", "", "");
                                    ...
                                    <div class="col-lg-5 col-sm-6 mb-2">
                                       <label><strong>Coupon Start & End Date Time</strong><i style="color: red;">*</i></label>
                                    ...
                                    <!--<div class="col-3" id="gcBtn">-->
                                    <!--   <label></label> <br>-->
                                    <!--   <button class="btn btn-info exampleModal"><i class="fa fa-download"></i> Download Coupon Code</button>-->
                                    <!--</div>-->
                                 </div>
                                 <br>
                              </div>
               ...
               <div class="form-group" id="customerpreference">
                  ...
                  <div class="row ">
                     <div class="col-md-12 ">
                        ...
                        <input class="form-control" type="number" name="climited" id="climited" oninput="this.value = this.value.replace(/[^0-9]/g, '');" maxlength="10">
                     </div>
                  </div>
               </div>
            </div>
...
<script>
   ...
   function generate_Coupon() {
    ...
    // alert(user_id);
      ...
      if ($('#used_BY').val().trim() == '') {
          toast('warning', 'Please Select Used BY');
          return false;
      }
       
       if ($('#totcoupon').val().trim() == ''|| ccode == 0 ) {
    ...
    //   alert(camt);
       if ($('#camt').val().trim().length < 1 || $('#camt').val().trim() == '' || camt == 0) {
   ...
   function viewtable() {
       ...
       var title = 'Coupon Reports : (' + formdate + '  to  ' + todate + ')';
           ...
           columns: [
               ...
               },
               {
                  ...
                  render: function(data, type, row, meta) {
                      return '<input class="form-control" style="width:169px;" type="text" value="' + data.startdate + '" readonly>'
                  }
                    // data: "startdate"
               },
               {
                  data: null,
                  render: function(data, type, row, meta) {
                      return '<input class="form-control" type="text" style="width:169px;" value="' + data.enddate + '" readonly>'
                  }
                    // data: "enddate"
               },
               {
                ...
                },
               {
                   data: null,
                   render: function(data, type, row, meta) {
                       return '<input class="form-control" type="text" style="width:169px;"  value="' + data.created_at + '" readonly>'
                   }
