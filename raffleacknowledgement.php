...
if ($subid2 != '') {
    ...
    if ($winnerlist['nr'] > 0) {
        ...
        $draw = select_query($con, "draw", "", "`id`='$draw_id' AND `raffle_status` != 'Active' ORDER BY `id` DESC LIMIT 1", "", "");
        if ($draw['nr'] > 0) {
            ...
            if ($ticket_lines['nr'] > 0) {
                ...
                if ($user_register['nr'] > 0) {
                    ...
                    if (isset($drawName)) {
                        $drawName = $drawName[0] . ' (' . date('D', strtotime($draw['result'][0]['result_datetime'])) . ')  – Just3Raffle ';
                    } else {
                        $drawName = '';
                    }
                    ...
                    $content .= '<tr>
                            ...
                            <tr>
                                ...
                                <td class="colon">:</td>
                                <td class="value">' . ucwords($user_register['result'][0]['name']) . ' </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="colon">:</td>
                                <td class="value">' . $ticket_lines['result'][0]['ticket_id'] . '</td>
                            </tr>
                            <tr>
