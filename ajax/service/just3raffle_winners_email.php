...
if ($method == "list_draw_winner" || $method == "announce") {
    ...
    if ($type == "announce") {
        ...
        $draw_arr = array("raffle_status" => 'Completed', 'just3_raffle_review' => 'Accepted');
        ...
        if ($errors != "") {
            ...
            $result['url'] = $adminurl . 'just3raffleannounce/list/' . $winnerid;
    ...
    if ($drawID != '') {
        ...
        $result['ded'] = ' <div class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                               <li><a href=" ' . $baseurl . 'rafflededreport_new.php?drawid=' . $drawID . '&proid=0&reportType=excel&pre=yes&prizeINC=yes" target="_blank" class="dropdown-item reportdwn" data-report="0" data-type="excel" href="#">Excel</a></li>
                                <li><a href=" ' . $baseurl . 'rafflerbddedreport.php?drawid=' . $drawID . '&proid=0" target="_blank" class="dropdown-item reportdwn" data-report="0" data-type="pdf" href="#">Pdf</a></li>
                              </ul>
                            </div>';
        ...
        $result['ldfullre'] = ' <div class="dropdown">
                              ...
                              <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                               <li><a href=" ' . $baseurl . 'rafflededreport.php?drawid=' . $drawID . '&proid=G&reportType=excel&pre=yes" target="_blank" class="dropdown-item reportdwn" data-report="0" data-type="excel" href="#">Excel</a></li>
    ...
    $draw_arr = ["just3_raffle_review" => 'Rejected'];
    ...
    if ($errors != "") {
        ...
        $ins_arr = ["messaged_by" => $currentUser, 'drawgroup' => 'JUST3RAFFLE', 'draw_status' => 'Rejected', 'message' => $RejectReason, 'drawid' => $drawID, 'ip' => getUserIP(), 'createdon' => $dubaidate_time];
