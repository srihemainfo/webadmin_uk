    ...
    $s_query = "
        ...
        (
            ...
            LEFT JOIN users_docs ud 
                ON cu.id = ud.user_id
            WHERE cu.vehicle_verify = '1'
            AND cu.vehicle_details->>'$.vehicle_review_message' = 'Wait for admin approval'
            AND cu.deletes = '0'
            AND kd.deletes = '0'
