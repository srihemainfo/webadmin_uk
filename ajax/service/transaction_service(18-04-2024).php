...
if ($method == "total_earnings") {
    ...
    /////////// Online Ticket ///////////////
    if ($roll_id == 1) {
        $oticket = mysqli_query($con, "SELECT SUM(I.netTotal) AS totalAmount FROM `invoice` AS I JOIN ndticket ON ndticket.id = I.ticketId WHERE I.ticketId = ndticket.id AND I.agent_id='0'AND I.deletes ='0';");
        ...
        $output .= '<div class="col-lg-6 col-md-6 col-sm-12 col-xl-3" style="display: inline-block;"><div class="card overflow-hidden"><div class="card-body"><div class="d-flex"><div class="mt-2"><h6 class="">Online Ticket</h6><h2 class="mb-0 number-font" id="totalonline">AED ';
        ...
        foreach ($productAmtArray as $productAmt => $totalAmt) {
            $output .= '<p class="aed-agent">AED ' . $productAmt . ' - ' . $totalAmt . ' </p>';
        }
    ...
    $output .= '<div class="col-lg-6 col-md-6 col-sm-12 col-xl-3"><div class="card overflow-hidden"><div class="card-body"><div class="d-flex"><div class="mt-2"><h6 class="">Agent Ticket</h6><h2 class="mb-0 number-font" id="totalagent">AED ';
    ...
    ///// Coupon Ticket /////
    // Coupon Ticket
    $oticket = mysqli_query($con, "SELECT SUM(I.netTotal) AS totalAmount FROM `invoice` AS I JOIN ndticket ON ndticket.id = I.ticketId WHERE I.agent_id != '0' AND I.ticketId = ndticket.id;"); // This query might be incorrect
    $row1 = mysqli_fetch_array($oticket);
    $totalAmount = $row1['totalAmount'];

    $output .= '<div class="col-lg-6 col-md-6 col-sm-12 col-xl-3"><div class="card overflow-hidden"><div class="card-body"><div class="d-flex"><div class="mt-2"><h6 class="">Coupon Ticket</h6><h2 class="mb-0 number-font" id="totalonline">AED ' . intval($totalAmount) . '</h2>'; // This line displays total amount
    ...
    $output .= '<div class="col-lg-6 col-md-6 col-sm-12 col-xl-3"><div class="card overflow-hidden"><div class="card-body"><div class="d-flex"><div class="mt-2"><h6 class="">Deleted Ticket Count</h6><h2 class="mb-0 number-font" id="totalonline">' . intval($totalAmount) . '</h2>';
    $output .= '</div></div></div></div></div>';
