 ...
 * 18/8/23         divya                       developed kticket
 */
...
if ($method == "deleteo_Ticket") {
    ...
    $result = sendpurchaseemail($con, $transid, $ottype, $tablename, $baseurl, $adminurl, $dubaidate_time);
    ...
    if ($type == 'OT') {
        ...
        $offline = select_query($con, "kticket", "", "`transaction_id`='$transid' ORDER BY `id` DESC", "", "");
        ...
        if ($errors != "") {
            ...
            $aticket_update = update($con, "kticket", "`id` = '$ticket_id' ", $aticket_arr, "", "", "", "");
...
function sendpurchaseemail($con, $transid, $ottype, $tablename, $baseurl, $adminurl, $dubaidate_time)
{
