...
//  var_dump($nationality,$residinglocation);die;
            $sql2 = "INSERT INTO `users_temp` (`user`, `roll_id`, `name`, `mobile`, `email`, `passport`, `deletes`, `status`, `created_at` , `otp`, `pass`, `created_by`, `password`,  `building_name`, `address`, `city`, `nationality`, `dialCode`, `lname`, `residinglocation`,`dob`)
                    VALUES ('', '0', '$_POST[name]', '$_POST[mobile]', '$_POST[email]', '',  '1', '0', '$dubaidate_time', '$otp', '$NewPassword', '$_SESSION[memid]', '$_POST[Password]', '$_POST[bulidingname]', '$address', '$city', '$nationality', '$_POST[countrycode]', '$lname', '$residinglocation','$_POST[dob]');";
        ...
        <table class="main" width="100%">
                    ...
                    <table class="column">
                        <tr>
                            <td valign="top" style="padding: 0;">
                                <center>
                                    <br>
                                    <img src="https://www.nationaldrawuae.com/assets/img/in-logo.png" style="border: 0px; margin:10px 0;  " width="50%">
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td valign="top" style="padding: 0;">
                                <center>
                                    <!-- <br> https://www.nationaldrawuae.com/assets/img/d-logo.png -->
                                    <img src="https://www.nationaldrawuae.com/assets/img/otp11.png" style="border-radius: 19px;" width="43%">
                                    <br>
                                </center>
                            </td>
                        </tr>
            ...
            <tr>
                <td class="column-one c-f">
                   <p style="font-size:17px; font-weight: 500!important; font-family: Verdana, sans-serif !important; margin:15px 0;">
            ...
            <tr>
                <td class="column-one">
                    <br>
                    <img style="width: !important;margin-top: 10px;" src="https://www.nationaldrawuae.com/assets/img/nd-f.png" width="84%">
                </td>
            </tr>
            <tr>
                <td>
