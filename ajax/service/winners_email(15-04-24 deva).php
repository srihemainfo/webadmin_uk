...
function winnerTemplate($baseurl, $prize, $amount, $my3number, $drawname, $drawdate, $strname, $name)
{
    ...
    //            <img src="https://www.nationaldraw.com/assets/images/mailtemplate/logo1.png" style="border: 0px;"  >
    ...
    //           <tr>
    //             <td valign="top"> <img style="border: 0px;margin: -80px 0 0px 10px;" src="https://www.nationaldraw.com/assets/images/mailtemplate/winner_man.png" >  </td>
    ...
    //              <img  style="width:500px !important;" src="https://www.nationaldraw.com/assets/images/mailtemplate/final_img.png">
       ...
       <body>
          <center class="wrapper">
             <table class="main" width="100%">
                      ...
                      <table class="column">
                         ...
                         <tr>
                            <td valign="top" style="padding: 0;">
                               <center>
                                  <br>
                                  <img src="' . constant('assetURL') . 'nationaldraw/1/WinnerEmailTemplate.png" style="border: 0px;" width="84%">
                                  <br>
                               </center>
                            </td>
                         </tr>
                ...
                <tr>
                   <td class="column-one">
                      <img style="margin-top: 19px;" src="' . constant('assetURL') . 'nationaldraw/1/EmailTemplateFooter.png" width="84%">
                   </td>
                </tr>
                <tr>
                   <td>
