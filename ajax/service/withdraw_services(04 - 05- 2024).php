...
// var_dump('kumar');die;
                    ...
                    // $Arrd2 = array("userid" => "$from_id", "uname" => "$req_fullname","umobile" => "$req_mobile","uemail" => "$req_email","opening_balance" => "$req_walletBalance", "total" => $topoint, "closeing_balance" => $walletBalance, "point_type" => 'WALLET', "transaction_type" => 'CREDIT', "reward_type" => 'AGENTTOPUP',"reference_id" => $PT_id,"reference_table" => 'point_request',"createdon" => $dubaidate_time,"updatedon" => $dubaidate_time);
