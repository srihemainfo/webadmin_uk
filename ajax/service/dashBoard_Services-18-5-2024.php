...
if ($method == "collect_earning") {
    ...
    $picup_count = $row1['count'];
    $picup_amount = $row1['amount'];
    $output .= '<div class="col-lg-6 col-md-6 col-sm-12 col-xl-3"><div class="card overflow-hidden"><div class="card-body"><div class="d-flex"><div class="mt-2"><h6 class="">Today Pick UP Schedule</h6><h5 class="mb-0 number-font" id="totalonline">Count - ' . intval($picup_count) . '<br> AED&nbsp;&nbsp;&nbsp;&nbsp;- '.intval($picup_amount).' </h5>';
    $output .= '</div></div></div></div></div>';
