...
elseif ($method == 'app_jobs_chart') {
    ...
    $sql = "SELECT c.*, 
            ...
            WHERE c.global_type IN ('carpool', 'dr_carpool') AND c.deletes = '0'";
    ...
    if (count($jobIds) > 0) {
        ...
        $invSql = "SELECT i.*, 
                   ...
                   LEFT JOIN customer_register cr2 ON i.invitee_user_id = cr2.id AND i.global_type != 'dr_carpool'
    ...
    $sql = "SELECT f.*, 
            ...
            WHERE f.global_type IN ('carpool', 'dr_carpool')";
