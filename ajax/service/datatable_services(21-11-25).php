...
elseif ($method == 'kycDetails') {
    ...
    try {
        ...
        if ($u_type == 'pending') {
            ...
            $filterParts[] = "cu.doc_verify = '0' AND kd.updated_by IS NULL AND kd.reject_reason IS NULL";
    ...
    try {
        ...
        if ($fetch_user['nr'] > 0) {
            ...
            if($tableData){
                ...
                // ✅ Step 5: Add or update other POST keys if present
...
$what_mess = '*Vehicle Verification Unsuccessful!*❌
