...
if ($method == "searchTicket") {
 ...
 $consolidated_Report = select_query($con, "draw", "", "`draw_no` = '$drawid' ORDER BY `id` DESC LIMIT 1", "", "");
    ...
    if ($rafflePrizeOne == '') {
        ...
        if ($getFirstRaffleData['nr'] == 0) {
            ...
            $draw_update = update($con, "pre_draw", "`draw_no` = '$draw_no' and `deletes`='0'", $draw_arr, "", "", "", "");
