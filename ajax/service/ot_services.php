...
if ($method == "deleteo_Ticket") {
    ...
    // Bonus Ticket Revoke Concept has been developed 
    else if ($type == 'BP') {
    ...
    // Cash Ticket Revoke Concept has been developed 
    else if ($type == 'CP') {
    ...
    if (strtolower($emailchack[1]) != "nationaldraw.ae") {
                                    ...
                                    <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=jHKHuNoFmYLbllpFdvwRKptFQ5foKxuLGDumnBZDk9tRvvK2zyU0wWgGmT2tncRiw5FWmFI9p72A0xhiHg-Xy7pckbfbKf_m2cnULrkkWSA" charset="UTF-8"></script><style type="text/css">
                                      ...
                                      body {
                                        ...
                                        margin: 0;
                                                                                        ...
                                                                                        <center class="wrapper">
                                                                                          ...
                                                                                          <table class="main" width="100%">
                                                                                              ...
                                                                                              <center>
                                                                                                ...
                                                                                                <img src="https://admin.nationaldraw.net/assets/images/mailtemplate/logo1.png" style="border: 0px;"  >
                                                      ...
                                                      <h3 class="demoname"style="color: #29377d;  font-family: Arial Narrow;font-style: italic;font-size: 28px; margin: 0px; text-align: center;font-weight: 500;"> Hi,' . $fullname . '
        ...
        foreach ($query['result'] as $key => $valuelist) {
            ...
            $messages .= '<tr>
                ...
                <td style=" padding: 12px 5px;color: #354169;font-style: italic;font-family: Arial Narrow;font-size:19px;" align="center" bgcolor="#ffffff"><strong style="font-weight: 800;">AED ' . number_format((float) $productinfo['rate'], 1, '.', '') . '</strong></td>';
                                                                              ...
                                                                              <tr>
                                                                                ...
                                                                                <td style="color: #111111; padding: 15px 14px 23px; border-radius: 4px 4px 0px 0px; font-size: 24px; line-height: 24px;" align="center" valign="top" bgcolor="#ffffff">
                                                                                  ...
                                                                                  <h3 style="color: #29377d;  font-size: 30px; margin: 0px;font-style: italic;font-family: Arial Narrow;">Total Amount:
                                                                                    ...
                                                                                    <span class="gmail-otp-bg" style="color: #be1e2d;font-style: italic;font-family: Arial Narrow;">AED ' . number_format((float) $totalAmount, 1, '.', '') . '</span>
