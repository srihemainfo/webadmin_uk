                ...
                <!-- KYC NOT COMPLETED -->
                 <div class="col-md-6 col-lg-4">
                    <div class="card shadow-sm border-start border-4 border-success">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="text-success fw-bold mb-1">KYC Not Completed</h6>
                                <a href="kyc-details/" 
                                   onclick="setCookie('isPending', true); setCookie('isVehicle', '');" 
                                   id="kyc_nc_count" 
                                   class="fw-semibold mb-0" 
                    ...
                    <div class="card shadow-sm border-start border-4 border-warning">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <a href="/joblist" 
                                   onclick="setCookie('isNotComplete', true); setCookie('isExpired', ''); setCookie('isCancelled', '');" 
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xl-6">
                  <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h4 class="card-title mb-0">Weekly Kyc Verify Report</h4>
                      <div>
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if(res.type == '1'){
                    ...
                    $('#kyc_nc_count').text(res.result[0].total ?? 0);
        ...
        var onsuccess = function (data) {
          try {
            ...
            //   $('#tot_v').html('New K&V ' + total);
                ...
                // $('#tot_v').html(
                //   `New KYC <a href="https://datahub.goride.uk/kyc-details" target="_blank" style="color: #007bff; text-decoration: none;">
                //      ${total}
                //   </a>`
                // );
          ...
          try {
            ...
            if (response.type == 1) {
              ...
              let total = (response.total || 'N/A');
                ...
                // $('#tot_veh').html(
                //   `New Vehicle <a href="https://datahub.goride.uk/kyc-details" target="_blank" style="color: #007bff; text-decoration: none;">
                //      ${total}
                //   </a>`
                // );
