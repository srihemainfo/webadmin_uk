...
// }
    ...
    if ($result) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            // ------------------------------------------------------------------
            $has_selfie = false;
            if ($row['k_updated_at'] !== null || $row['selfie_status'] !== null || $row['kyc_dl_status'] !== null) {
                $has_selfie = true; 
            }
            if ($row['doc_verify'] > 0) {
                $has_selfie = true;
            ...
            // Note: The $dl_response json decode error checking has been successfully removed from here.
