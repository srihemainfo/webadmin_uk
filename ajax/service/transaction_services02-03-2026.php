...
/////////  NEW /////////////////
    ...
    $query = "SELECT  p.transaction_id, p.category, p.gateway, p.createdon, p.paymentStatus,p.finaltotal,p.grandtotal, u.name, u.lname,u.mobile, u.email, u.lastlogin, t.ticketNo , pl.response as 'payMentFinal'
        FROM payment_history p 
        INNER JOIN user_register u ON p.user_id = u.id
    ...
    while ($row = mysqli_fetch_assoc($payment_history)) {
        ...
        if ($row['paymentStatus'] == 'Success' && $row['category'] !== 'WalletDeposit') {
