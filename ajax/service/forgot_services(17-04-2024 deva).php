                 ...
                 <table class="main" width="100%">
                          ...
                          <table class="column">
                             ...
                             <tr>
                                <td valign="top" style="padding: 0;">
                                   <center>
                                      <br>
                                      <img src="' . constant('assetURL') . 'nationaldraw/1/RegistrationOTPTemplate.png" style="border: 0px;"
                                         width="84%">
                                      <br>
                                   </center>
                                </td>
                    ...
                    <tr>
                       <td class="column-one c-f">
                        <p style="font-weight: 600!important;">Hi ' . $name . ' ' . ($usercheck['result'][0]['lname'] ?? '') . ',</p>
        
                        <p  style="font-size: 14px; font-weight: 400!important; font-family: Verdana, sans-serif !important; margin-top: 9px;">Are you excited to Play with National Draw</p>
                          <p
                             style="font-size:17px; font-weight: 400!important; font-family: Verdana, sans-serif !important; margin:11px 0;">
                             Forgot your Password?
                          </p>
                          <p  style="font-size: 14px; font-weight: 400!important; font-family: Verdana, sans-serif !important; ">
                            Please use the below OTP to reset your password<br>which will be valid for 05 minutes
                        </p>
                    ...
                    <tr>
                       <td>
                          <ul
                             style="color: #01104e;font-family: Verdana, sans-serif !important;font-size: 15px;font-weight: 500; list-style: none; text-align: center; padding: 0; margin:10px 0 ; line-height: 1.5;">
                             <li>' . $otp[0] . '</li>
                             <li>' . $otp[1] . '</li>
                             <li>' . $otp[2] . '</li>
                             <li>' . $otp[3] . '</li>
                    ...
                    <tr>
                       <td class="column-one ">
                          <p
                             style="font-size:14px; font-weight: 400!important; font-family: Verdana, sans-serif !important; margin:10px 0;">
                    ...
                    <tr>
                       <td class="column-one">
                          <img style="margin-top: 10px;" src="' . constant('assetURL') . 'nationaldraw/1/EmailTemplateFooter.png"
                             width="84%">
                       </td>
                    </tr>
                    <tr>
