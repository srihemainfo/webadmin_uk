    ...
    try {
        ...
        if ($winnerlist['nr'] > 0) {
            ...
            foreach ($winnerlist['result'] as $key => $value) {
                ...
                $result[] = array("soldby" => $soldby, "name" => $cusname, "email" => $email, "mobile" => $mobile, "id" => $value['id'], "RaffleNO" => $winningNumber, "TicketID" => $ticketNo, "prize" => $value['prize'], "prizeamt" => $value['prize_amt'], "ticketReferenceID" => $value['ticketReferenceID'], 'action' => $action, 'drawType' => $drawType);
            }
        }
