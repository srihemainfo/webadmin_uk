            ...
            if ($winnerDetails['RaffleID'] != '') {
                ...
                if ($checkWinnerlist['nr'] < 1) {
                            ...
                            <table class="main" width="100%">
                                ...
                                <tr>
                                    <td class="column-one c-f">
                                     ...
                                     <p style="font-size: 15px; font-weight: 400!important; margin: 16px 0; ">Congratulations on winning a prize of  ' . strval($winnerDetails['prize']) . ' GM (AED ' . $winnerDetails['prizeAmt'] . ') in <br>the ' . ($checkDraw['result'][0]['dailyThrillName'] . ' Draw #' . str_pad($checkDraw['result'][0]['dailyDrawNo'], 3, '0', STR_PAD_LEFT)) . ' held on ' . date("dS M Y", strtotime($checkDraw['result'][0]['resultDate'])) . '.
                                     </p>
                    ...
                    if ($winnerDetails['Email'] != '') {
                     ...
                     $today1_gold_price = trim((string)$winnerDetails['prize']);
                    
                    $gold_image = [
                        '2' => 'nationaldraw/1/2Gram Gold image.png',
                        '4' => 'nationaldraw/1/4GramGoldimage.png',
                        '6' => 'nationaldraw/1/6GramGoldimage.jpeg',
                        '8' => 'nationaldraw/1/8GramGoldimage.jpeg',
                        '10' => 'nationaldraw/1/10GramGoldimage.jpeg',
                        '12' => 'nationaldraw/1/12GramGoldimage.jpeg',
                        '14' => 'nationaldraw/1/14GramGoldimage.jpeg',
                        '16' => 'nationaldraw/1/16GramGoldimage.jpeg',
                        '18' => 'nationaldraw/1/18GramGoldimage.jpeg',
                        '20' => 'nationaldraw/1/20GramGoldimage.jpeg',
                        '22' => 'nationaldraw/1/22GramGoldimage.jpeg',
                        '24' => 'nationaldraw/1/24GramGoldimage.jpeg',
                    ];
                    ...
                    if ($winnerlistIns['id'] != '') {
                       ...
                       if($winnerDetails['prize'] !='' && $winnerDetails['Mobile'] != ''){
                            
                            if (isset($gold_image[$today1_gold_price])) {
                                
                             
                                $image_url = assetURL.''.$gold_image[$today1_gold_price];
                                // $encoded_url = urlencode(assetURL . '' . $gold_image[$today1_gold_price]);
                            
                                    $message = "🎊 CONGRATULATIONS!!!! 🎉🏆\n\n"
                                         . "Hi {{name}},\n\n"
                                         . "*Happy News From National Draw!!*\n\n"
                                         . "You are our lucky winner of *winning {{prize}} grams of gold* in our *'{{dailyThrillName}} Draw' - Day {{dailyDrawNo}}*.\n"
                                         . "🌟✨ Keep the excitement going and stay tuned for more chances to win! 🎁🍀\n\n"
                                         . "📸 We would like to request you provide a photograph of you to add to our winners gallery 👤 and publish on our social media pages. 🥳\n\n"
                                         . "🍀🤞🏻 Purchase more and Win Big Gold!!! 🔊📢\n\n"
                                         . "With Love,\n"
                                         . "National Draw 🍀";

                                
                                $message = str_replace('{{name}}', $winnerDetails['Name'], $message);
                                $message = str_replace('{{prize}}', $winnerDetails['prize'], $message);
                                $message = str_replace('{{dailyThrillName}}', $checkDraw['result'][0]['dailyThrillName'], $message);
                                $message = str_replace('{{dailyDrawNo}}', $checkDraw['result'][0]['dailyDrawNo'], $message);   
                                ...
                                $request = [
                                    ...
                                    'messages' => $message,
                                    'urlFile' => $image_url,
                                    'fileName' => $winnerDetails['prize'].'Gram Gold image.png',
                                    'con' => $con,
                                    'resend' => false
                                ];
                                ...
                                if($response){
                                     $result['type'] = '1';
                                     $result['result'] = 'The Winner WhatsApp Send successfully';
                                }else{
                                    $result['type'] = '1';
                                ...
                                $result["type"] = "0";
                                $result["result"] = "The Winner Price gold image not found!";
                                goto resultFI;
                            }
        ...
        if ($monthlyBumperStatus === 'Active') {
            ...
            if ($winnerDetails['RaffleID'] != '') {
                ...
                <body>
                    ...
                    $gold_image = [
                        '50' => 'nationaldraw/1/50GramMonth.jpg',
                        '100' => 'nationaldraw/1/100GramMonth.jpg',
                        '150' => 'nationaldraw/1/150GramMonth.jpg',
                        '200' => 'nationaldraw/1/200GramMonth.jpg',
                        '250' => 'nationaldraw/1/250GramMonth.jpg',
                        '300' => 'nationaldraw/1/300GramMonth.jpg',
                        '350' => 'nationaldraw/1/350GramMonth.jpg',
                        '400' => 'nationaldraw/1/400GramMonth.jpg',
                        '450' => 'nationaldraw/1/450GramMonth.jpg',
                        '500' => 'nationaldraw/1/500GramMonth.jpg',
                        '1000' => 'nationaldraw/1/1000GramMonth.jpg',
                    ...
                    if ($winnerlistIns['id'] != '') {
                        $image_url = assetURL.''.$gold_image[$today1_gold_price];
                                ...
                                $message = str_replace('{{name}}', $winnerDetails['Name'], $message);
                                $message = str_replace('{{prize}}', $winnerDetails['prize'], $message);
                                $message = str_replace('{{dailyThrillName}}', $checkDraw['result'][0]['monthlyBumperName'], $message);
                                $message = str_replace('{{dailyDrawNo}}', $checkDraw['result'][0]['dailyDrawNo'], $message);   
        ...
        if ($weeklyBoosterStatus === 'Active') {
            ...
            if ($winnerDetails['RaffleID'] != '') {
                ...
                <body>
                    ...
                    $gold_image = [
                        '24' => 'nationaldraw/1/24GramWBD.jpg',
                        '26' => 'nationaldraw/1/26GramWBD.jpg',
                        '28' => 'nationaldraw/1/28GramWBD.jpg',
                        '30' => 'nationaldraw/1/30GramWBD.jpg',
                        '32' => 'nationaldraw/1/32GramWBD.jpg',
                        '34' => 'nationaldraw/1/34GramWBD.jpg',
                        '36' => 'nationaldraw/1/36GramWBD.jpg',
                        '38' => 'nationaldraw/1/38GramWBD.jpg',
                        '40' => 'nationaldraw/1/40GramWBD.jpg',
                        '42' => 'nationaldraw/1/42GramWBD.jpg',
                        '44' => 'nationaldraw/1/44GramWBD.jpg',
                        '46' => 'nationaldraw/1/46GramWBD.jpg',
                        '48' => 'nationaldraw/1/48GramWBD.jpg',
                        '50' => 'nationaldraw/1/50GramWBD.jpg',
                        '52' => 'nationaldraw/1/52GramWBD.jpg',
                        '54' => 'nationaldraw/1/54GramWBD.jpg',
                        '56' => 'nationaldraw/1/56GramWBD.jpg',
                        '58' => 'nationaldraw/1/58GramWBD.jpg',
                        '60' => 'nationaldraw/1/60GramWBD.jpg',
                        '62' => 'nationaldraw/1/62GramWBD.jpg',
                        '64' => 'nationaldraw/1/64GramWBD.jpg',
                        '66' => 'nationaldraw/1/66GramWBD.jpg',
                        '68' => 'nationaldraw/1/68GramWBD.jpg',
                        '70' => 'nationaldraw/1/70GramWBD.jpg',
                        '72' => 'nationaldraw/1/72GramWBD.jpg',
                        '74' => 'nationaldraw/1/74GramWBD.jpg',
                        '76' => 'nationaldraw/1/76GramWBD.jpg',
                        '78' => 'nationaldraw/1/78GramWBD.jpg',
                        '80' => 'nationaldraw/1/80GramWBD.jpg',
                        '82' => 'nationaldraw/1/82GramWBD.jpg',
                        '84' => 'nationaldraw/1/84GramWBD.jpg',
                        '86' => 'nationaldraw/1/86GramWBD.jpg',
                        '88' => 'nationaldraw/1/88GramWBD.jpg',
                        '90' => 'nationaldraw/1/90GramWBD.jpg',
                        '92' => 'nationaldraw/1/92GramWBD.jpg',
                        '94' => 'nationaldraw/1/94GramWBD.jpg',
                        '96' => 'nationaldraw/1/96GramWBD.jpg',
                        '98' => 'nationaldraw/1/98GramWBD.jpg',
                        '100' => 'nationaldraw/1/100GramWBD.jpg',
                    ];
                    ...
                    if ($winnerlistIns['id'] != '') {
                        ...
                        if($winnerDetails['prize'] !='' && $winnerDetails['Mobile'] != ''){
                            ...
                            if (isset($gold_image[$today1_gold_price])) {
                                ...
                                $message = str_replace('{{name}}', $winnerDetails['Name'], $message);
                                $message = str_replace('{{prize}}', $winnerDetails['prize'], $message);
                                $message = str_replace('{{dailyThrillName}}', $checkDraw['result'][0]['weeklyBoosterName'], $message);
                                $message = str_replace('{{dailyDrawNo}}', $checkDraw['result'][0]['dailyDrawNo'], $message);   
