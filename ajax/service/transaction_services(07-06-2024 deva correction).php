...
/////////  NEW /////////////////
    ...
    $query = "SELECT  p.transaction_id, p.gateway, p.createdon, p.paymentStatus,p.finaltotal, u.name, u.lname,u.mobile, u.email, u.lastlogin, t.ticketNo , pl.response as 'payMentFinal'
        FROM payment_history p 
        INNER JOIN user_register u ON p.user_id = u.id
